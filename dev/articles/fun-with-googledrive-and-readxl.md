...
#> [1] "/tmp/RtmpxAw9Bb/iris-26d3a1226fa.csv"
...
#> Local file:
#> • /tmp/RtmpxAw9Bb/iris-26d3a1226fa.csv
#> Uploaded into Drive file:
#> • iris-26d3a1226fa <id: 11aKfwrfx-BXJNR3FzPD-YL5Msyz9HLcXyOLNNwO1tDo>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-26d3a1226fa 11aKfwr… <named list [37]>
...
#> ✔ Reading from iris-26d3a1226fa.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpxAw9Bb/iris-26d3a1226fa.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26d3a1226fa <id: 11aKfwrfx-BXJNR3FzPD-YL5Msyz9HLcXyOLNNwO1tDo>
#> Saved locally as:
#> • /tmp/RtmpxAw9Bb/iris-26d3a1226fa.xlsx
```
