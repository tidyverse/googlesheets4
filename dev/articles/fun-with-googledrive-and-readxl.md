...
#> [1] "/tmp/RtmpV6W4Lt/iris-27ae6451a860.csv"
...
#> Local file:
#> • /tmp/RtmpV6W4Lt/iris-27ae6451a860.csv
#> Uploaded into Drive file:
#> • iris-27ae6451a860 <id: 1hXlhCpqMgFUsxQznatT8-MsL6D7gM68OotEH2YBQwwI>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-27ae6451a860 1hXlhCp… <named list [38]>
...
#> ✔ Reading from iris-27ae6451a860.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpV6W4Lt/iris-27ae6451a860.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-27ae6451a860 <id: 1hXlhCpqMgFUsxQznatT8-MsL6D7gM68OotEH2YBQwwI>
#> Saved locally as:
#> • /tmp/RtmpV6W4Lt/iris-27ae6451a860.xlsx
```
