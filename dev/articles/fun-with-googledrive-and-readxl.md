...
#> [1] "/tmp/Rtmp07hJzI/iris-24694dcd9e75.csv"
...
#> Local file:
#> • /tmp/Rtmp07hJzI/iris-24694dcd9e75.csv
#> Uploaded into Drive file:
#> • iris-24694dcd9e75 <id: 1Sha-uNzGC8DTILLZvtR9fyRRmstXGjRr2jYyY69oCKM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24694dcd9e75 1Sha-uN… <named list [37]>
...
#> ✔ Reading from iris-24694dcd9e75.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp07hJzI/iris-24694dcd9e75.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24694dcd9e75 <id: 1Sha-uNzGC8DTILLZvtR9fyRRmstXGjRr2jYyY69oCKM>
#> Saved locally as:
#> • /tmp/Rtmp07hJzI/iris-24694dcd9e75.xlsx
```
