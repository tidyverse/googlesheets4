...
#> [1] "/tmp/RtmpJcsJHd/iris-267a1e82b7ff.csv"
...
#> Local file:
#> • /tmp/RtmpJcsJHd/iris-267a1e82b7ff.csv
#> Uploaded into Drive file:
#> • iris-267a1e82b7ff <id: 1vN8NWg01ZcuD5bogcGUPrFHP7Rb1FxBlSOBRJnOw_lM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-267a1e82b7ff 1vN8NWg… <named list [39]>
...
#> ✔ Reading from iris-267a1e82b7ff.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpJcsJHd/iris-267a1e82b7ff.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-267a1e82b7ff <id: 1vN8NWg01ZcuD5bogcGUPrFHP7Rb1FxBlSOBRJnOw_lM>
#> Saved locally as:
#> • /tmp/RtmpJcsJHd/iris-267a1e82b7ff.xlsx
```
