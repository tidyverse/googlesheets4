...
#> [1] "/tmp/RtmpOdXtCB/iris-27313f0674de.csv"
...
#> Local file:
#> • /tmp/RtmpOdXtCB/iris-27313f0674de.csv
#> Uploaded into Drive file:
#> • iris-27313f0674de <id: 1BkOprpHBa1QHYIJfsRcv44BPYGGThDta8Bw_N8dubbo>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-27313f0674de 1BkOprp… <named list [37]>
...
#> ✔ Reading from iris-27313f0674de.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpOdXtCB/iris-27313f0674de.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-27313f0674de <id: 1BkOprpHBa1QHYIJfsRcv44BPYGGThDta8Bw_N8dubbo>
#> Saved locally as:
#> • /tmp/RtmpOdXtCB/iris-27313f0674de.xlsx
```
