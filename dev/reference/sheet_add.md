...
#> 1 eggplant        0  1.40e9 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.56e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.21e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.87e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.26e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  6.96e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 13YDVYbq-nwNTrCe6aepGQm9b8_ZQXq8MlrpQRB9HG20>
```
