...
#> [1] "/tmp/RtmpYZlznA/iris-26e44913b5c5.csv"
...
#> Local file:
#> • /tmp/RtmpYZlznA/iris-26e44913b5c5.csv
#> Uploaded into Drive file:
#> • iris-26e44913b5c5 <id: 1JPphDDKXlyJtcCVM5x4vqJ2nDkXVNWMLJ2zr_jK-fAI>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26e44913b5c5 1JPphDD… <named list [37]>
...
#> ✔ Reading from iris-26e44913b5c5.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpYZlznA/iris-26e44913b5c5.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26e44913b5c5 <id: 1JPphDDKXlyJtcCVM5x4vqJ2nDkXVNWMLJ2zr_jK-fAI>
#> Saved locally as:
#> • /tmp/RtmpYZlznA/iris-26e44913b5c5.xlsx
```
