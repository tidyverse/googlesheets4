...
#> [1] "/tmp/Rtmpo6MPjR/iris-25061464d73.csv"
...
#> Local file:
#> • /tmp/Rtmpo6MPjR/iris-25061464d73.csv
#> Uploaded into Drive file:
#> • iris-25061464d73 <id: 10BognW77xiobevonh-ZFWBXV3IWZU9tVtDGf1W0Tx7g>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-25061464d73 10BognW… <named list [37]>
...
#> ✔ Reading from iris-25061464d73.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpo6MPjR/iris-25061464d73.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25061464d73 <id: 10BognW77xiobevonh-ZFWBXV3IWZU9tVtDGf1W0Tx7g>
#> Saved locally as:
#> • /tmp/Rtmpo6MPjR/iris-25061464d73.xlsx
```
