...
#> [1] "/tmp/RtmpVnQltA/iris-24ed6e23c23a.csv"
...
#> Local file:
#> • /tmp/RtmpVnQltA/iris-24ed6e23c23a.csv
#> Uploaded into Drive file:
#> • iris-24ed6e23c23a <id: 1MD5gzHtQLPLhOnRJn4lsXa9sZ3D7zTjItTzGGwhMxgE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24ed6e23c23a 1MD5gzH… <named list [39]>
...
#> ✔ Reading from iris-24ed6e23c23a.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpVnQltA/iris-24ed6e23c23a.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24ed6e23c23a <id: 1MD5gzHtQLPLhOnRJn4lsXa9sZ3D7zTjItTzGGwhMxgE>
#> Saved locally as:
#> • /tmp/RtmpVnQltA/iris-24ed6e23c23a.xlsx
```
