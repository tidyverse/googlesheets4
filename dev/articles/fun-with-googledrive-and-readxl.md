...
#> [1] "/tmp/RtmpbG8G5S/iris-252829115b9.csv"
...
#> Local file:
#> • /tmp/RtmpbG8G5S/iris-252829115b9.csv
#> Uploaded into Drive file:
#> • iris-252829115b9 <id: 1MiiwXEZRrHCfyd84qqPR5Ax_lTZ9ChoD9Yycr-6PauU>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-252829115b9 1MiiwXE… <named list [38]>
...
#> ✔ Reading from iris-252829115b9.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpbG8G5S/iris-252829115b9.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-252829115b9 <id: 1MiiwXEZRrHCfyd84qqPR5Ax_lTZ9ChoD9Yycr-6PauU>
#> Saved locally as:
#> • /tmp/RtmpbG8G5S/iris-252829115b9.xlsx
```
