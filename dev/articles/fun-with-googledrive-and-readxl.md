...
#> [1] "/tmp/RtmpVLK2Cx/iris-253b3f4cfcf9.csv"
...
#> Local file:
#> • /tmp/RtmpVLK2Cx/iris-253b3f4cfcf9.csv
#> Uploaded into Drive file:
#> • iris-253b3f4cfcf9 <id: 1wmTNR2Lbl-28BPASpTw_-HiUSx-NYjzf8p5i_VJVkPw>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-253b3f4cfcf9 1wmTNR2… <named list [38]>
...
#> ✔ Reading from iris-253b3f4cfcf9.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpVLK2Cx/iris-253b3f4cfcf9.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-253b3f4cfcf9 <id: 1wmTNR2Lbl-28BPASpTw_-HiUSx-NYjzf8p5i_VJVkPw>
#> Saved locally as:
#> • /tmp/RtmpVLK2Cx/iris-253b3f4cfcf9.xlsx
```
