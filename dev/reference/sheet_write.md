...
#> File trashed:
#> • heartsick-sealion <id: 14MKKx8sLpIdEWdFzjgO-QARCRCtYdzJbiQNs_wneSfQ>
...
#> 1 alpha     0  159192306 GRID  TRUE            2            1 <NULL>
#> 2 omega     1 1053944631 GRID  TRUE           33           11 <NULL>
#> 3 df        2  409471578 GRID  TRUE            4            2 <NULL>
...
#> File trashed:
#> • sheet-write-demo <id: 1l7TtgEOfsdgDO0LbPezJc2kXw9M9wNZGcydulHYJPs4>
```
