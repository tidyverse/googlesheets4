...
#> [1] "/tmp/Rtmpjzmd5v/iris-247958f4bf69.csv"
...
#> Local file:
#> • /tmp/Rtmpjzmd5v/iris-247958f4bf69.csv
#> Uploaded into Drive file:
#> • iris-247958f4bf69 <id: 16DksuM8pLWaXjd6RM_zbhIWP-U2ZQDuy5SBr9DxW518>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-247958f4bf69 16DksuM… <named list [37]>
...
#> ✔ Reading from iris-247958f4bf69.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpjzmd5v/iris-247958f4bf69.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-247958f4bf69 <id: 16DksuM8pLWaXjd6RM_zbhIWP-U2ZQDuy5SBr9DxW518>
#> Saved locally as:
#> • /tmp/Rtmpjzmd5v/iris-247958f4bf69.xlsx
```
