...
#> [1] "/tmp/RtmpxhBPZm/iris-246061a88f51.csv"
...
#> Local file:
#> • /tmp/RtmpxhBPZm/iris-246061a88f51.csv
#> Uploaded into Drive file:
#> • iris-246061a88f51 <id: 1DNHvrNE21tYgBX6DJGclJrbSl3xYQ4uhh8EMMgED6CE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-246061a88f51 1DNHvrN… <named list [38]>
...
#> ✔ Reading from iris-246061a88f51.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpxhBPZm/iris-246061a88f51.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-246061a88f51 <id: 1DNHvrNE21tYgBX6DJGclJrbSl3xYQ4uhh8EMMgED6CE>
#> Saved locally as:
#> • /tmp/RtmpxhBPZm/iris-246061a88f51.xlsx
```
