...
#> [1] "/tmp/RtmpZReJi8/iris-2702199a3662.csv"
...
#> Local file:
#> • /tmp/RtmpZReJi8/iris-2702199a3662.csv
#> Uploaded into Drive file:
#> • iris-2702199a3662 <id: 1uYusbeDx0lnjgAjWyUUgtA0eYNPjryNnOvQK-qLwj_g>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2702199a3662 1uYusbe… <named list [37]>
...
#> ✔ Reading from iris-2702199a3662.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpZReJi8/iris-2702199a3662.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2702199a3662 <id: 1uYusbeDx0lnjgAjWyUUgtA0eYNPjryNnOvQK-qLwj_g>
#> Saved locally as:
#> • /tmp/RtmpZReJi8/iris-2702199a3662.xlsx
```
