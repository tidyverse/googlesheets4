...
#> [1] "/tmp/RtmpsVKkH5/iris-2960fd25005.csv"
...
#> Local file:
#> • /tmp/RtmpsVKkH5/iris-2960fd25005.csv
#> Uploaded into Drive file:
#> • iris-2960fd25005 <id: 1-9puZ5qbrfPJhiktwKM6i_Ygzu0a5VrpY4AUtNvgFj8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2960fd25005 1-9puZ5… <named list [38]>
...
#> [1] "/tmp/RtmpsVKkH5/iris-2960fd25005.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2960fd25005 <id: 1-9puZ5qbrfPJhiktwKM6i_Ygzu0a5VrpY4AUtNvgFj8>
#> Saved locally as:
#> • /tmp/RtmpsVKkH5/iris-2960fd25005.xlsx
```
