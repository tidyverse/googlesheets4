...
#> [1] "/tmp/RtmpBGT9By/iris-24f339857568.csv"
...
#> Local file:
#> • /tmp/RtmpBGT9By/iris-24f339857568.csv
#> Uploaded into Drive file:
#> • iris-24f339857568 <id: 18Kkqgex5cgp4iCl92CkWpYHAWyMyRmn6hClNYLsSK1o>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24f339857568 18Kkqge… <named list [38]>
...
#> ✔ Reading from iris-24f339857568.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpBGT9By/iris-24f339857568.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24f339857568 <id: 18Kkqgex5cgp4iCl92CkWpYHAWyMyRmn6hClNYLsSK1o>
#> Saved locally as:
#> • /tmp/RtmpBGT9By/iris-24f339857568.xlsx
```
