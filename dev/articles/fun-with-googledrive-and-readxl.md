...
#> [1] "/tmp/RtmphxGl0v/iris-28253b805f45.csv"
...
#> Local file:
#> • /tmp/RtmphxGl0v/iris-28253b805f45.csv
#> Uploaded into Drive file:
#> • iris-28253b805f45 <id: 13g4QHSSSDmNLxhhsbftS7k8kfaYWyIrm_rwUbLrlMbU>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-28253b805f45 13g4QHS… <named list [37]>
...
#> ✔ Reading from iris-28253b805f45.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmphxGl0v/iris-28253b805f45.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-28253b805f45 <id: 13g4QHSSSDmNLxhhsbftS7k8kfaYWyIrm_rwUbLrlMbU>
#> Saved locally as:
#> • /tmp/RtmphxGl0v/iris-28253b805f45.xlsx
```
