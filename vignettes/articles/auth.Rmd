...
If you don't need to access private Sheets, use `sheets_deauth()` to indicate there is no need for a token. This puts googlesheets4 into a de-authorized mode.
...
Users can take control of auth proactively via the [`sheets_auth*()` family of functions](https://googlesheets4.tidyverse.org/reference/index.html#section-auth). Examples of what you can control or provide:
