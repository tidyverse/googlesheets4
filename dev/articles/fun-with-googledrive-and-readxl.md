...
#> [1] "/tmp/RtmprPiOau/iris-279778c3c99c.csv"
...
#> Local file:
#> • /tmp/RtmprPiOau/iris-279778c3c99c.csv
#> Uploaded into Drive file:
#> • iris-279778c3c99c <id: 1Q2CgJdtX5KVXRENgollqnvVaomxSz6QCfYK03IG18lo>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-279778c3c99c 1Q2CgJd… <named list [37]>
...
#> ✔ Reading from iris-279778c3c99c.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmprPiOau/iris-279778c3c99c.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-279778c3c99c <id: 1Q2CgJdtX5KVXRENgollqnvVaomxSz6QCfYK03IG18lo>
#> Saved locally as:
#> • /tmp/RtmprPiOau/iris-279778c3c99c.xlsx
```
