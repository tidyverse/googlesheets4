...
Read from a URL, a Sheet ID, or a [`dribble`](https://googledrive.tidyverse.org/reference/dribble.html) produced by the googledrive package. These all achieve the same thing:
