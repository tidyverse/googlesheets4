...
#> [1] "/tmp/Rtmp1LxNpq/iris-24435a22d9f0.csv"
...
#> Local file:
#> • /tmp/Rtmp1LxNpq/iris-24435a22d9f0.csv
#> Uploaded into Drive file:
#> • iris-24435a22d9f0 <id: 1iu8B_R_IVk-1UnZgoxfTYQJxeUqcnDTkCUGD7LvwNsc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24435a22d9f0 1iu8B_R… <named list [38]>
...
#> ✔ Reading from iris-24435a22d9f0.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp1LxNpq/iris-24435a22d9f0.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24435a22d9f0 <id: 1iu8B_R_IVk-1UnZgoxfTYQJxeUqcnDTkCUGD7LvwNsc>
#> Saved locally as:
#> • /tmp/Rtmp1LxNpq/iris-24435a22d9f0.xlsx
```
