...
#> [1] "/tmp/Rtmpf6sowp/iris-2542419f1637.csv"
...
#> Local file:
#> • /tmp/Rtmpf6sowp/iris-2542419f1637.csv
#> Uploaded into Drive file:
#> • iris-2542419f1637 <id: 1LY4gvRVNcMyUqfM5PWoDJsBj6j7Fbg5Hn-L9wPJkCxk>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2542419f1637 1LY4gvR… <named list [38]>
...
#> ✔ Reading from iris-2542419f1637.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpf6sowp/iris-2542419f1637.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2542419f1637 <id: 1LY4gvRVNcMyUqfM5PWoDJsBj6j7Fbg5Hn-L9wPJkCxk>
#> Saved locally as:
#> • /tmp/Rtmpf6sowp/iris-2542419f1637.xlsx
```
