...
#> ✔ Creating new Sheet: bighearted-junco.
#> 
#> ── <googlesheets4_spreadsheet> ────────────────────────────────────────
#> Spreadsheet name: bighearted-junco                            
#>               ID: 1QO7WB8UUF3eMysY6w8dywC36pfVMt1hFdd_Lau0SwAE
#>           Locale: en_US                                       
#>        Time zone: Etc/GMT                                     
#>      # of sheets: 1                                           
#> 
...
range_speedread(ss)
#> ✔ Reading from bighearted-junco.
#> ℹ Export URL:
#>   <https://docs.google.com/spreadsheets/d/1QO7WB8UUF3eMysY6w8dywC36pfVMt1hFdd_Lau0SwAE/export?format=csv>
#> Rows: 71 Columns: 2
...
#> File trashed:
#> • bighearted-junco <id: 1QO7WB8UUF3eMysY6w8dywC36pfVMt1hFdd_Lau0SwAE>
```
