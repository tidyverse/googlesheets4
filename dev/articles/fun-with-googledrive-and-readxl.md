...
#> [1] "/tmp/RtmpbgYu9O/iris-269759aac0e0.csv"
...
#> Local file:
#> • /tmp/RtmpbgYu9O/iris-269759aac0e0.csv
#> Uploaded into Drive file:
#> • iris-269759aac0e0 <id: 1GoDqhD8u3yTknynq5j1Jv7KFdF6qY2wZaudQTmOETSc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-269759aac0e0 1GoDqhD… <named list [37]>
...
#> ✔ Reading from iris-269759aac0e0.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpbgYu9O/iris-269759aac0e0.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-269759aac0e0 <id: 1GoDqhD8u3yTknynq5j1Jv7KFdF6qY2wZaudQTmOETSc>
#> Saved locally as:
#> • /tmp/RtmpbgYu9O/iris-269759aac0e0.xlsx
```
