...
#> [1] "/tmp/RtmpRPlt8x/iris-2773695a4d40.csv"
...
#> Local file:
#> • /tmp/RtmpRPlt8x/iris-2773695a4d40.csv
#> Uploaded into Drive file:
#> • iris-2773695a4d40 <id: 12OWlh_6QLGUlIO4SHkPixdrbgjQc52Kc4qdJs5xxJtM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2773695a4d40 12OWlh_… <named list [37]>
...
#> ✔ Reading from iris-2773695a4d40.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpRPlt8x/iris-2773695a4d40.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2773695a4d40 <id: 12OWlh_6QLGUlIO4SHkPixdrbgjQc52Kc4qdJs5xxJtM>
#> Saved locally as:
#> • /tmp/RtmpRPlt8x/iris-2773695a4d40.xlsx
```
