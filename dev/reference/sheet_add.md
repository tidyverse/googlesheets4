...
#> 1 eggplant        0  8.86e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  2.95e8 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.82e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  2.03e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.28e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  2.58e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 10k6c2SGGxUg_E2suM-AX-A4Jdfey84TdOv7DSdBXpms>
```
