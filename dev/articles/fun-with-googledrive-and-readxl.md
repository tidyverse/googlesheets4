...
#> [1] "/tmp/RtmpqdpZty/iris-23e088d5eea.csv"
...
#> Local file:
#> • /tmp/RtmpqdpZty/iris-23e088d5eea.csv
#> Uploaded into Drive file:
#> • iris-23e088d5eea <id: 1RmRmuoomrh8Gr686bczgdplof-ZpSnQe4R7_I4h3nb4>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-23e088d5eea 1RmRmuo… <named list [37]>
...
#> ✔ Reading from iris-23e088d5eea.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpqdpZty/iris-23e088d5eea.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-23e088d5eea <id: 1RmRmuoomrh8Gr686bczgdplof-ZpSnQe4R7_I4h3nb4>
#> Saved locally as:
#> • /tmp/RtmpqdpZty/iris-23e088d5eea.xlsx
```
