...
If you can make your point with one of the example Sheets, exposed via `gs4_examples()` and `gs4_example()`, do so! You can call `sheets_deauth()` explicitly in your reprex to shut down any attempt to get a token.
