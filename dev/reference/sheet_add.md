...
#> 1 eggplant        0  6.75e7 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.68e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.81e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  7.02e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  5.26e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  2.45e7 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1uGPx_g7qqGMOVVdtOyQ0KfDpm6p4xwQFJSqsXdtfYjc>
```
