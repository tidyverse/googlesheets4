...
#> [1] "/tmp/RtmpuWR8zg/iris-24b2120988d5.csv"
...
#> Local file:
#> • /tmp/RtmpuWR8zg/iris-24b2120988d5.csv
#> Uploaded into Drive file:
#> • iris-24b2120988d5 <id: 1y3ATbk9a-QXwgZBE_NzPzZR2Wj6HcKWQfF11cSrv5C8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24b2120988d5 1y3ATbk… <named list [38]>
...
#> ✔ Reading from iris-24b2120988d5.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpuWR8zg/iris-24b2120988d5.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24b2120988d5 <id: 1y3ATbk9a-QXwgZBE_NzPzZR2Wj6HcKWQfF11cSrv5C8>
#> Saved locally as:
#> • /tmp/RtmpuWR8zg/iris-24b2120988d5.xlsx
```
