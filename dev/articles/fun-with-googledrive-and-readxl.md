...
#> [1] "/tmp/RtmpTAO7Jf/iris-25f81be5b691.csv"
...
#> Local file:
#> • /tmp/RtmpTAO7Jf/iris-25f81be5b691.csv
#> Uploaded into Drive file:
#> • iris-25f81be5b691 <id: 1EFwbcg3gA0pzRl6JjUO7a4deHxvYZUjyDajmT9G19yc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25f81be5b691 1EFwbcg… <named list [39]>
...
#> ✔ Reading from iris-25f81be5b691.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpTAO7Jf/iris-25f81be5b691.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25f81be5b691 <id: 1EFwbcg3gA0pzRl6JjUO7a4deHxvYZUjyDajmT9G19yc>
#> Saved locally as:
#> • /tmp/RtmpTAO7Jf/iris-25f81be5b691.xlsx
```
