...
It is common to use googlesheets4 together with [googledrive](https://googledrive.tidyverse.org). See the article [Using googlesheets4 with googledrive](https://googlesheets4.tidyverse.org/articles/articles/drive-and-sheets.html) for advice on how to streamline auth in this case.
