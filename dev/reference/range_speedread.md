...
#>               ID: 1-eiGUIOMZki4EYto2h3tJMrFsdCCVryyCciKLCJN26k
#>           Locale: en_US                                       
#>        Time zone: Etc/GMT                                     
#>      # of sheets: 1                                           
#> 
...
#> ℹ Export URL:
#>   <https://docs.google.com/spreadsheets/d/1-eiGUIOMZki4EYto2h3tJMrFsdCCVryyCciKLCJN26k/export?format=csv>
#> Rows: 71 Columns: 2
...
#> File trashed:
#> • fiery-hart <id: 1-eiGUIOMZki4EYto2h3tJMrFsdCCVryyCciKLCJN26k>
```
