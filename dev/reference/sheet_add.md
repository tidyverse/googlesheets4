...
#> 1 eggplant        0  7.37e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.83e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.22e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  3.80e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.44e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  1.18e9 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1t28uCZubwx9ErY-ix6KQfU55WoHbEFNmR8js1i4WTow>
```
