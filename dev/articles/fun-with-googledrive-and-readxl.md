...
#> [1] "/tmp/RtmpWvpJqL/iris-26c0409afca7.csv"
...
#> Local file:
#> • /tmp/RtmpWvpJqL/iris-26c0409afca7.csv
#> Uploaded into Drive file:
#> • iris-26c0409afca7 <id: 1Y7uXYnTeIzyflL5pKBHcpXLLl3tfc-oX4WI4qf0pTX8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26c0409afca7 1Y7uXYn… <named list [37]>
...
#> ✔ Reading from iris-26c0409afca7.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpWvpJqL/iris-26c0409afca7.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26c0409afca7 <id: 1Y7uXYnTeIzyflL5pKBHcpXLLl3tfc-oX4WI4qf0pTX8>
#> Saved locally as:
#> • /tmp/RtmpWvpJqL/iris-26c0409afca7.xlsx
```
