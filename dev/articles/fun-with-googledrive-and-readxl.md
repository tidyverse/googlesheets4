...
#> [1] "/tmp/Rtmp2AtBFZ/iris-28402c2a3a52.csv"
...
#> Local file:
#> • /tmp/Rtmp2AtBFZ/iris-28402c2a3a52.csv
#> Uploaded into Drive file:
#> • iris-28402c2a3a52 <id: 10rZxQoyPC6ToWqCphBQ0G7E-tB_X6vtm7gkYgr7pm_s>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-28402c2a3a52 10rZxQo… <named list [37]>
...
#> ✔ Reading from iris-28402c2a3a52.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp2AtBFZ/iris-28402c2a3a52.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-28402c2a3a52 <id: 10rZxQoyPC6ToWqCphBQ0G7E-tB_X6vtm7gkYgr7pm_s>
#> Saved locally as:
#> • /tmp/Rtmp2AtBFZ/iris-28402c2a3a52.xlsx
```
