...
#> 1 eggplant        0  9.80e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  2.14e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.23e8 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.43e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.28e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  3.82e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1WqztF4hrpSWY1GarsFBWCtrictorCYwMmrpEsIpcRuY>
```
