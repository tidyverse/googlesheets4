...
#> [1] "/tmp/RtmpJMRtW5/iris-25ac24553f2c.csv"
...
#> Local file:
#> • /tmp/RtmpJMRtW5/iris-25ac24553f2c.csv
#> Uploaded into Drive file:
#> • iris-25ac24553f2c <id: 11fZcnDSfgcfljI2D0UU1kvzfe54CjR3vGeli-Y4Ke5s>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25ac24553f2c 11fZcnD… <named list [38]>
...
#> ✔ Reading from iris-25ac24553f2c.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpJMRtW5/iris-25ac24553f2c.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25ac24553f2c <id: 11fZcnDSfgcfljI2D0UU1kvzfe54CjR3vGeli-Y4Ke5s>
#> Saved locally as:
#> • /tmp/RtmpJMRtW5/iris-25ac24553f2c.xlsx
```
