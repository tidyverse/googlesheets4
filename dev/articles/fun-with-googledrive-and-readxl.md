...
#> [1] "/tmp/RtmpGQthUa/iris-25815819f3af.csv"
...
#> Local file:
#> • /tmp/RtmpGQthUa/iris-25815819f3af.csv
#> Uploaded into Drive file:
#> • iris-25815819f3af <id: 1-Vyn7gAsVCSSoyUW1B8oHHJiodmj6dT0ypMiZGLmdwQ>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25815819f3af 1-Vyn7g… <named list [38]>
...
#> ✔ Reading from iris-25815819f3af.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpGQthUa/iris-25815819f3af.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25815819f3af <id: 1-Vyn7gAsVCSSoyUW1B8oHHJiodmj6dT0ypMiZGLmdwQ>
#> Saved locally as:
#> • /tmp/RtmpGQthUa/iris-25815819f3af.xlsx
```
