...
#> [1] "/tmp/RtmpcLaogP/iris-23fe3b41ad17.csv"
...
#> Local file:
#> • /tmp/RtmpcLaogP/iris-23fe3b41ad17.csv
#> Uploaded into Drive file:
#> • iris-23fe3b41ad17 <id: 1mQcGtTrveTU97ABS_oFPNYndfAQNJjbVjb43Kc5joyo>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-23fe3b41ad17 1mQcGtT… <named list [37]>
...
#> ✔ Reading from iris-23fe3b41ad17.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpcLaogP/iris-23fe3b41ad17.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-23fe3b41ad17 <id: 1mQcGtTrveTU97ABS_oFPNYndfAQNJjbVjb43Kc5joyo>
#> Saved locally as:
#> • /tmp/RtmpcLaogP/iris-23fe3b41ad17.xlsx
```
