# ---- nm_fun ----
me_ <- nm_fun("TEST-sheets_sheet_relocate")
...
test_that("relocation works", {
  ...
  sheets_sheet_relocate(ss, "echo", .before = "bravo")
  sheets_sheet_relocate(ss, list("foxtrot", 4))
  sheets_sheet_relocate(ss, c("bravo", "alfa", "echo"), .after = 10)
  expect_equal(
