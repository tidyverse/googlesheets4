...
#> 1 eggplant        0  3.86e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.74e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.32e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  9.03e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  5.35e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  5.81e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1h6e2CaPTqkZIAS2bJXexdk3wLD-UgAdSh-te6qjGmAE>
```
