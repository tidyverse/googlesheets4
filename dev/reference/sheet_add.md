...
#> 1 eggplant        0  1.82e9 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  4.92e8 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  8.56e8 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.08e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.22e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  4.59e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1a08tsOSJDfwWNGuI53aLLUPpkExNRXxJ9XI2Gz3dfEI>
```
