...
#> [1] "/tmp/RtmpONSFi5/iris-27374e7222d8.csv"
...
#> Local file:
#> • /tmp/RtmpONSFi5/iris-27374e7222d8.csv
#> Uploaded into Drive file:
#> • iris-27374e7222d8 <id: 1bRBmHFWaiwZU2KaAS4C5l2jyv7xuYCIqPXVJX-ujtt8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-27374e7222d8 1bRBmHF… <named list [37]>
...
#> ✔ Reading from iris-27374e7222d8.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpONSFi5/iris-27374e7222d8.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-27374e7222d8 <id: 1bRBmHFWaiwZU2KaAS4C5l2jyv7xuYCIqPXVJX-ujtt8>
#> Saved locally as:
#> • /tmp/RtmpONSFi5/iris-27374e7222d8.xlsx
```
