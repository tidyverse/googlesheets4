...
#> 1 eggplant        0  1.94e9 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  8.44e7 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  5.26e8 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  2.40e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  6.69e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  4.01e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1g4CSwSsK4sp-EoEp5HexsMN5ei3ZHpgMEoB9_RyLcAw>
```
