...
#> [1] "/tmp/RtmpnTcDEP/iris-276c5fd1e52c.csv"
...
#> Local file:
#> • /tmp/RtmpnTcDEP/iris-276c5fd1e52c.csv
#> Uploaded into Drive file:
#> • iris-276c5fd1e52c <id: 1OOsValee-NaW4ZIKPXmmBkgVbKRdL2T7zAVjbXukPnY>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-276c5fd1e52c 1OOsVal… <named list [37]>
...
#> ✔ Reading from iris-276c5fd1e52c.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpnTcDEP/iris-276c5fd1e52c.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-276c5fd1e52c <id: 1OOsValee-NaW4ZIKPXmmBkgVbKRdL2T7zAVjbXukPnY>
#> Saved locally as:
#> • /tmp/RtmpnTcDEP/iris-276c5fd1e52c.xlsx
```
