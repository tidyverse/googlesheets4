...
#> [1] "/tmp/Rtmp0EqfUb/iris-23c54cd1d98.csv"
...
#> Local file:
#> • /tmp/Rtmp0EqfUb/iris-23c54cd1d98.csv
#> Uploaded into Drive file:
#> • iris-23c54cd1d98 <id: 1Vy5WyMXpQJM3y0ez4oQjewlCkAyFvuHvn_SSUm9m1tI>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-23c54cd1d98 1Vy5WyM… <named list [38]>
...
#> ✔ Reading from iris-23c54cd1d98.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp0EqfUb/iris-23c54cd1d98.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-23c54cd1d98 <id: 1Vy5WyMXpQJM3y0ez4oQjewlCkAyFvuHvn_SSUm9m1tI>
#> Saved locally as:
#> • /tmp/Rtmp0EqfUb/iris-23c54cd1d98.xlsx
```
