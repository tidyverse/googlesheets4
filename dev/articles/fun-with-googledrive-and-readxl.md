...
#> [1] "/tmp/RtmpcGESDN/iris-25874a43f328.csv"
...
#> Local file:
#> • /tmp/RtmpcGESDN/iris-25874a43f328.csv
#> Uploaded into Drive file:
#> • iris-25874a43f328 <id: 1psaTmzkT8vL8pKiO4QptwrW1ngxYjdMaT7bzaufOLY0>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25874a43f328 1psaTmz… <named list [38]>
...
#> ✔ Reading from iris-25874a43f328.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpcGESDN/iris-25874a43f328.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25874a43f328 <id: 1psaTmzkT8vL8pKiO4QptwrW1ngxYjdMaT7bzaufOLY0>
#> Saved locally as:
#> • /tmp/RtmpcGESDN/iris-25874a43f328.xlsx
```
