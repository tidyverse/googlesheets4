...
#> [1] "/tmp/Rtmp8fuLAE/iris-2710764d6032.csv"
...
#> Local file:
#> • /tmp/Rtmp8fuLAE/iris-2710764d6032.csv
#> Uploaded into Drive file:
#> • iris-2710764d6032 <id: 1HU430209u9OTjF_53CPvfPM00-R8dDT0N7ZifqDZp0U>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2710764d6032 1HU4302… <named list [37]>
...
#> ✔ Reading from iris-2710764d6032.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp8fuLAE/iris-2710764d6032.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2710764d6032 <id: 1HU430209u9OTjF_53CPvfPM00-R8dDT0N7ZifqDZp0U>
#> Saved locally as:
#> • /tmp/Rtmp8fuLAE/iris-2710764d6032.xlsx
```
