...
#> [1] "/tmp/RtmpdDBQgr/iris-24ff3ed3d198.csv"
...
#> Local file:
#> • /tmp/RtmpdDBQgr/iris-24ff3ed3d198.csv
#> Uploaded into Drive file:
#> • iris-24ff3ed3d198 <id: 1AwKEcF8KMVEXmSCbqw4cdkmqQUwa3q4gSlo4jUffrPM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24ff3ed3d198 1AwKEcF… <named list [37]>
...
#> ✔ Reading from iris-24ff3ed3d198.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpdDBQgr/iris-24ff3ed3d198.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24ff3ed3d198 <id: 1AwKEcF8KMVEXmSCbqw4cdkmqQUwa3q4gSlo4jUffrPM>
#> Saved locally as:
#> • /tmp/RtmpdDBQgr/iris-24ff3ed3d198.xlsx
```
