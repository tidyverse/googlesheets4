...
#> [1] "/tmp/RtmpeZNVsb/iris-281b7e026030.csv"
...
#> Local file:
#> • /tmp/RtmpeZNVsb/iris-281b7e026030.csv
#> Uploaded into Drive file:
#> • iris-281b7e026030 <id: 1UdQ9cc0DsFF3eKu3qaLbsYD0E_r7aIvihWu92Ov1RYA>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-281b7e026030 1UdQ9cc… <named list [37]>
...
#> ✔ Reading from iris-281b7e026030.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpeZNVsb/iris-281b7e026030.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-281b7e026030 <id: 1UdQ9cc0DsFF3eKu3qaLbsYD0E_r7aIvihWu92Ov1RYA>
#> Saved locally as:
#> • /tmp/RtmpeZNVsb/iris-281b7e026030.xlsx
```
