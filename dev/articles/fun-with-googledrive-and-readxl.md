...
#> [1] "/tmp/RtmpeAYsLA/iris-26ed7593187f.csv"
...
#> Local file:
#> • /tmp/RtmpeAYsLA/iris-26ed7593187f.csv
#> Uploaded into Drive file:
#> • iris-26ed7593187f <id: 1-5dXqQPxIH-Dqb8jWxkL4HX0axPpv-BD6HfgeScFnnk>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26ed7593187f 1-5dXqQ… <named list [37]>
...
#> ✔ Reading from iris-26ed7593187f.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpeAYsLA/iris-26ed7593187f.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26ed7593187f <id: 1-5dXqQPxIH-Dqb8jWxkL4HX0axPpv-BD6HfgeScFnnk>
#> Saved locally as:
#> • /tmp/RtmpeAYsLA/iris-26ed7593187f.xlsx
```
