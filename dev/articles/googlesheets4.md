...
#>               ID: 1jq_R5R-K5Jf1aLMVnGituXBZrqlaffARkvA8AleEEhE
#>           Locale: en_US                                       
#>        Time zone: Etc/GMT                                     
#>      # of sheets: 1                                           
#> 
...
#>               ID: 1eI4DeyyiRTgAhkabg7rnD0SA7OnWP5NqnG_xrWxqYNE
#>           Locale: en_US                                       
#>        Time zone: Etc/GMT                                     
#>      # of sheets: 1                                           
#> 
...
#>   name     index         id type  visible grid_rows grid_columns data  
#>   <chr>    <int>      <int> <chr> <lgl>       <int>        <int> <list>
#> 1 df           0  460816470 GRID  TRUE            9            2 <NULL>
#> 2 chickwts     1 1775772854 GRID  TRUE           72            2 <NULL>

googledrive::drive_trash(ss)
#> File trashed:
#> • testy-hedgehog <id: 1eI4DeyyiRTgAhkabg7rnD0SA7OnWP5NqnG_xrWxqYNE>
```
