...
#> [1] "/tmp/RtmpU3XtVX/iris-26db6b93bab7.csv"
...
#> Local file:
#> • /tmp/RtmpU3XtVX/iris-26db6b93bab7.csv
#> Uploaded into Drive file:
#> • iris-26db6b93bab7 <id: 1iC9z3jFFOHflqgco2Rrin7OuBVmevk0T70ShrPcxPFM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26db6b93bab7 1iC9z3j… <named list [37]>
...
#> ✔ Reading from iris-26db6b93bab7.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpU3XtVX/iris-26db6b93bab7.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26db6b93bab7 <id: 1iC9z3jFFOHflqgco2Rrin7OuBVmevk0T70ShrPcxPFM>
#> Saved locally as:
#> • /tmp/RtmpU3XtVX/iris-26db6b93bab7.xlsx
```
