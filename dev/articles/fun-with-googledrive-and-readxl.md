...
#> [1] "/tmp/RtmppJzsia/iris-248034cbfb87.csv"
...
#> Local file:
#> • /tmp/RtmppJzsia/iris-248034cbfb87.csv
#> Uploaded into Drive file:
#> • iris-248034cbfb87 <id: 1MQeOSnnOdnxIfwyuVdpCnte8Sd-ag1xo4k4Bc7YzaxQ>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-248034cbfb87 1MQeOSn… <named list [37]>
...
#> ✔ Reading from iris-248034cbfb87.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmppJzsia/iris-248034cbfb87.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-248034cbfb87 <id: 1MQeOSnnOdnxIfwyuVdpCnte8Sd-ag1xo4k4Bc7YzaxQ>
#> Saved locally as:
#> • /tmp/RtmppJzsia/iris-248034cbfb87.xlsx
```
