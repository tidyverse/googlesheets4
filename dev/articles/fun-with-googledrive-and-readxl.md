...
#> [1] "/tmp/RtmpCYs9NA/iris-24ed447936e0.csv"
...
#> Local file:
#> • /tmp/RtmpCYs9NA/iris-24ed447936e0.csv
#> Uploaded into Drive file:
#> • iris-24ed447936e0 <id: 1l_kpRoaMNu9yRGhkZFUZQgn7WOLyF2RkxnTBwECPeOQ>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24ed447936e0 1l_kpRo… <named list [38]>
...
#> ✔ Reading from iris-24ed447936e0.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpCYs9NA/iris-24ed447936e0.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24ed447936e0 <id: 1l_kpRoaMNu9yRGhkZFUZQgn7WOLyF2RkxnTBwECPeOQ>
#> Saved locally as:
#> • /tmp/RtmpCYs9NA/iris-24ed447936e0.xlsx
```
