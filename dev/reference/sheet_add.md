...
#> 1 eggplant        0  6.04e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.70e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  8.49e8 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.97e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  9.66e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  2.99e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1RBUhi8gjmi0oBQGU7ZyQqIL_lqF-F-kVSEidxXEfqu8>
```
