...
#> [1] "/tmp/RtmpBm3EBi/iris-2479228b2bd.csv"
...
#> Local file:
#> • /tmp/RtmpBm3EBi/iris-2479228b2bd.csv
#> Uploaded into Drive file:
#> • iris-2479228b2bd <id: 1j_E1vzCqG9M7-M9gZshu75gUfz4JNi1LCbRlZfu3RIc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2479228b2bd 1j_E1vz… <named list [37]>
...
#> [1] "/tmp/RtmpBm3EBi/iris-2479228b2bd.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2479228b2bd <id: 1j_E1vzCqG9M7-M9gZshu75gUfz4JNi1LCbRlZfu3RIc>
#> Saved locally as:
#> • /tmp/RtmpBm3EBi/iris-2479228b2bd.xlsx
```
