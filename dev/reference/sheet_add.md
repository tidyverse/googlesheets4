...
#> 1 eggplant        0  9.70e8 GRID  TRUE            3            6 <NULL>
...
#> 6 coconut         5  9.59e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  1.49e9 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1YpnDKxl4ISu6K7P1GpAYvuGJzfXAr8ZM-5TegrChvbE>
```
