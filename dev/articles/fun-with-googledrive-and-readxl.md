...
#> [1] "/tmp/RtmpWywGnO/iris-243314d76564.csv"
...
#> Local file:
#> • /tmp/RtmpWywGnO/iris-243314d76564.csv
#> Uploaded into Drive file:
#> • iris-243314d76564 <id: 1LeoSlNC4oplhyU4YumYOpY6elxDwFyz3pSdqipBg4G8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-243314d76564 1LeoSlN… <named list [37]>
...
#> ✔ Reading from iris-243314d76564.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpWywGnO/iris-243314d76564.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-243314d76564 <id: 1LeoSlNC4oplhyU4YumYOpY6elxDwFyz3pSdqipBg4G8>
#> Saved locally as:
#> • /tmp/RtmpWywGnO/iris-243314d76564.xlsx
```
