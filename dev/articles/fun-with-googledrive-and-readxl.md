...
#> [1] "/tmp/RtmpCCSmtp/iris-251d7938dcdc.csv"
...
#> Local file:
#> • /tmp/RtmpCCSmtp/iris-251d7938dcdc.csv
#> Uploaded into Drive file:
#> • iris-251d7938dcdc <id: 1YY5FzgNjQlzaqWTsC1mn64Y6exFUjvzaSsDbjXyFufQ>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-251d7938dcdc 1YY5Fzg… <named list [39]>
...
#> ✔ Reading from iris-251d7938dcdc.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpCCSmtp/iris-251d7938dcdc.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-251d7938dcdc <id: 1YY5FzgNjQlzaqWTsC1mn64Y6exFUjvzaSsDbjXyFufQ>
#> Saved locally as:
#> • /tmp/RtmpCCSmtp/iris-251d7938dcdc.xlsx
```
