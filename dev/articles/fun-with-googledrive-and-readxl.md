...
#> [1] "/tmp/RtmpPTLucl/iris-24ca17b6541.csv"
...
#> Local file:
#> • /tmp/RtmpPTLucl/iris-24ca17b6541.csv
#> Uploaded into Drive file:
#> • iris-24ca17b6541 <id: 1mq9vPE14QnGR6h8bX7YpYvxKx5-z_tKULgUfX6A0H3M>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-24ca17b6541 1mq9vPE… <named list [37]>
...
#> ✔ Reading from iris-24ca17b6541.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpPTLucl/iris-24ca17b6541.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24ca17b6541 <id: 1mq9vPE14QnGR6h8bX7YpYvxKx5-z_tKULgUfX6A0H3M>
#> Saved locally as:
#> • /tmp/RtmpPTLucl/iris-24ca17b6541.xlsx
```
