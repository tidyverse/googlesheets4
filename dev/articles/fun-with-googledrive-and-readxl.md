...
#> [1] "/tmp/RtmpoBwScU/iris-25513f9a2da2.csv"
...
#> Local file:
#> • /tmp/RtmpoBwScU/iris-25513f9a2da2.csv
#> Uploaded into Drive file:
#> • iris-25513f9a2da2 <id: 10iC0vajbbEqB0U3zk-_hJl8TSv2NVqNscmpxwKdT3HE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25513f9a2da2 10iC0va… <named list [37]>
...
#> ✔ Reading from iris-25513f9a2da2.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpoBwScU/iris-25513f9a2da2.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25513f9a2da2 <id: 10iC0vajbbEqB0U3zk-_hJl8TSv2NVqNscmpxwKdT3HE>
#> Saved locally as:
#> • /tmp/RtmpoBwScU/iris-25513f9a2da2.xlsx
```
