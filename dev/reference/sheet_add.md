...
#> 1 eggplant        0  2.65e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.81e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.44e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  8.41e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  5.48e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  4.46e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1676vewgdapLdRNr-aSiOB-HOEgRUy1R3PYA7khw3Ols>
```
