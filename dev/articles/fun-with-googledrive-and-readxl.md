...
#> [1] "/tmp/RtmpdaaGDE/iris-26f811e922d.csv"
...
#> Local file:
#> • /tmp/RtmpdaaGDE/iris-26f811e922d.csv
#> Uploaded into Drive file:
#> • iris-26f811e922d <id: 1T5ga2wW9ifcbDur2CkcSk3eShNERLomXMFrGe_e8m5A>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-26f811e922d 1T5ga2w… <named list [37]>
...
#> ✔ Reading from iris-26f811e922d.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpdaaGDE/iris-26f811e922d.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26f811e922d <id: 1T5ga2wW9ifcbDur2CkcSk3eShNERLomXMFrGe_e8m5A>
#> Saved locally as:
#> • /tmp/RtmpdaaGDE/iris-26f811e922d.xlsx
```
