...
#>               ID: 1crF9axU1Jv2ns3zSecHbXJx2HtO8DkIS7lDNmgA7Ipk
#>           Locale: en_US                                       
#>        Time zone: Etc/GMT                                     
#>      # of sheets: 1                                           
#> 
...
#> ℹ Export URL:
#>   <https://docs.google.com/spreadsheets/d/1crF9axU1Jv2ns3zSecHbXJx2HtO8DkIS7lDNmgA7Ipk/export?format=csv>
#> Rows: 71 Columns: 2
...
#> File trashed:
#> • fiery-hart <id: 1crF9axU1Jv2ns3zSecHbXJx2HtO8DkIS7lDNmgA7Ipk>
```
