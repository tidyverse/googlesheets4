...
#> [1] "/tmp/RtmpWGSKnE/iris-26951289a85.csv"
...
#> Local file:
#> • /tmp/RtmpWGSKnE/iris-26951289a85.csv
#> Uploaded into Drive file:
#> • iris-26951289a85 <id: 1IaOZV13C3q8MFeGINGsxA2WE7zXBFOheYtgCF2WwxdQ>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-26951289a85 1IaOZV1… <named list [37]>
...
#> ✔ Reading from iris-26951289a85.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpWGSKnE/iris-26951289a85.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26951289a85 <id: 1IaOZV13C3q8MFeGINGsxA2WE7zXBFOheYtgCF2WwxdQ>
#> Saved locally as:
#> • /tmp/RtmpWGSKnE/iris-26951289a85.xlsx
```
