...
#> [1] "/tmp/RtmpDMFi0c/iris-253e15c134d4.csv"
...
#> Local file:
#> • /tmp/RtmpDMFi0c/iris-253e15c134d4.csv
#> Uploaded into Drive file:
#> • iris-253e15c134d4 <id: 193WeNyHPlTbIV5ixeTydsNKT1jFTcFApDpCaD9l1MZM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-253e15c134d4 193WeNy… <named list [38]>
...
#> ✔ Reading from iris-253e15c134d4.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpDMFi0c/iris-253e15c134d4.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-253e15c134d4 <id: 193WeNyHPlTbIV5ixeTydsNKT1jFTcFApDpCaD9l1MZM>
#> Saved locally as:
#> • /tmp/RtmpDMFi0c/iris-253e15c134d4.xlsx
```
