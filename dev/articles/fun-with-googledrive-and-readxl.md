...
#> [1] "/tmp/Rtmp3Rr9iN/iris-255a30939d10.csv"
...
#> Local file:
#> • /tmp/Rtmp3Rr9iN/iris-255a30939d10.csv
#> Uploaded into Drive file:
#> • iris-255a30939d10 <id: 1t8A1Tv-_364DFwTzNwyT-_PM0GSSsIsGDTk_FskGTXU>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-255a30939d10 1t8A1Tv… <named list [38]>
...
#> ✔ Reading from iris-255a30939d10.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp3Rr9iN/iris-255a30939d10.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-255a30939d10 <id: 1t8A1Tv-_364DFwTzNwyT-_PM0GSSsIsGDTk_FskGTXU>
#> Saved locally as:
#> • /tmp/Rtmp3Rr9iN/iris-255a30939d10.xlsx
```
