...
#> [1] "/tmp/RtmpLaBK2k/iris-24c259216984.csv"
...
#> Local file:
#> • /tmp/RtmpLaBK2k/iris-24c259216984.csv
#> Uploaded into Drive file:
#> • iris-24c259216984 <id: 1SVWKiZOJKYnqMbCimSButINHLNU7MDI4KhbFs1Hg9aE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24c259216984 1SVWKiZ… <named list [38]>
...
#> ✔ Reading from iris-24c259216984.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpLaBK2k/iris-24c259216984.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24c259216984 <id: 1SVWKiZOJKYnqMbCimSButINHLNU7MDI4KhbFs1Hg9aE>
#> Saved locally as:
#> • /tmp/RtmpLaBK2k/iris-24c259216984.xlsx
```
