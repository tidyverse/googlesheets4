...
#> File trashed:
#> • heartsick-sealion <id: 1tm3MHs2szmyuDYYVvzziUkPkX-i82pCNGv8UJqIitjw>
...
#> 1 alpha     0  625983575 GRID  TRUE            2            1 <NULL>
#> 2 omega     1  856957424 GRID  TRUE           33           11 <NULL>
#> 3 df        2 1513427276 GRID  TRUE            4            2 <NULL>
...
#> File trashed:
#> • sheet-write-demo <id: 1D4zluqJri7j-Pwfqm0pkTiI6HYvEeM-mQjMqhfg0TKs>
```
