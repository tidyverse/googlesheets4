...
#> [1] "/tmp/Rtmp41tUar/iris-25502eefd55f.csv"
...
#> Local file:
#> • /tmp/Rtmp41tUar/iris-25502eefd55f.csv
#> Uploaded into Drive file:
#> • iris-25502eefd55f <id: 1b_CVV0ZIk79snMvAHgfu_rXyrmuJ14U67hKVYg4kEXA>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25502eefd55f 1b_CVV0… <named list [38]>
...
#> ✔ Reading from iris-25502eefd55f.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp41tUar/iris-25502eefd55f.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25502eefd55f <id: 1b_CVV0ZIk79snMvAHgfu_rXyrmuJ14U67hKVYg4kEXA>
#> Saved locally as:
#> • /tmp/Rtmp41tUar/iris-25502eefd55f.xlsx
```
