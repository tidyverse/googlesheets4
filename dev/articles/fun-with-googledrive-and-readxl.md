...
#> [1] "/tmp/RtmpiKflkb/iris-2427500863c3.csv"
...
#> Local file:
#> • /tmp/RtmpiKflkb/iris-2427500863c3.csv
#> Uploaded into Drive file:
#> • iris-2427500863c3 <id: 1Qxf4tPUT-8E0-Fg596obURgu-CtqmpC2oYwUYDrHfaM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2427500863c3 1Qxf4tP… <named list [37]>
...
#> ✔ Reading from iris-2427500863c3.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpiKflkb/iris-2427500863c3.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2427500863c3 <id: 1Qxf4tPUT-8E0-Fg596obURgu-CtqmpC2oYwUYDrHfaM>
#> Saved locally as:
#> • /tmp/RtmpiKflkb/iris-2427500863c3.xlsx
```
