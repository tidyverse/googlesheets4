...
As of mid-April 2020, note that all of the writing/modifying features are only in the dev version, but a CRAN release will happen soon. This website documents the dev version.
