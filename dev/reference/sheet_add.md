...
#> 1 eggplant        0  1.13e9 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.39e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  3.54e8 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  6.94e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.83e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  4.97e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1S0JkWALEFTlpSLasKTNeAImhfGfJbp47tKf1mogkvYk>
```
