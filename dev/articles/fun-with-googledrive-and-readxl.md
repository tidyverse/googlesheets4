...
#> [1] "/tmp/Rtmp00fRKU/iris-265042f96319.csv"
...
#> Local file:
#> • /tmp/Rtmp00fRKU/iris-265042f96319.csv
#> Uploaded into Drive file:
#> • iris-265042f96319 <id: 1DZFpxFJo8ZRLJl9pM0zMRMQuBE6SYntc7C0L4_HIlzw>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-265042f96319 1DZFpxF… <named list [37]>
...
#> ✔ Reading from iris-265042f96319.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp00fRKU/iris-265042f96319.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-265042f96319 <id: 1DZFpxFJo8ZRLJl9pM0zMRMQuBE6SYntc7C0L4_HIlzw>
#> Saved locally as:
#> • /tmp/Rtmp00fRKU/iris-265042f96319.xlsx
```
