...
#> [1] "/tmp/RtmpXxZfs2/iris-25467501ee0f.csv"
...
#> Local file:
#> • /tmp/RtmpXxZfs2/iris-25467501ee0f.csv
#> Uploaded into Drive file:
#> • iris-25467501ee0f <id: 1TDoqRRZTlq_lURQyupFgUzt-dL5GDjjkFvZfkHf408s>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25467501ee0f 1TDoqRR… <named list [38]>
...
#> ✔ Reading from iris-25467501ee0f.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpXxZfs2/iris-25467501ee0f.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25467501ee0f <id: 1TDoqRRZTlq_lURQyupFgUzt-dL5GDjjkFvZfkHf408s>
#> Saved locally as:
#> • /tmp/RtmpXxZfs2/iris-25467501ee0f.xlsx
```
