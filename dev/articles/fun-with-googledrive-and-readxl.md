...
#> [1] "/tmp/RtmpVw6sqf/iris-2503252f3fed.csv"
...
#> Local file:
#> • /tmp/RtmpVw6sqf/iris-2503252f3fed.csv
#> Uploaded into Drive file:
#> • iris-2503252f3fed <id: 1cmaRv2p3ZD2hBbwpgjfQDrpWXXLlqJpg1RABDdYuLmg>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2503252f3fed 1cmaRv2… <named list [37]>
...
#> ✔ Reading from iris-2503252f3fed.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpVw6sqf/iris-2503252f3fed.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2503252f3fed <id: 1cmaRv2p3ZD2hBbwpgjfQDrpWXXLlqJpg1RABDdYuLmg>
#> Saved locally as:
#> • /tmp/RtmpVw6sqf/iris-2503252f3fed.xlsx
```
