...
#> [1] "/tmp/RtmpFGct9F/iris-242a1a8356bd.csv"
...
#> Local file:
#> • /tmp/RtmpFGct9F/iris-242a1a8356bd.csv
#> Uploaded into Drive file:
#> • iris-242a1a8356bd <id: 1jGiLLMts5PID3mrIxez79AZPus4IyhC9BzyS27_w8_c>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-242a1a8356bd 1jGiLLM… <named list [37]>
...
#> ✔ Reading from iris-242a1a8356bd.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpFGct9F/iris-242a1a8356bd.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-242a1a8356bd <id: 1jGiLLMts5PID3mrIxez79AZPus4IyhC9BzyS27_w8_c>
#> Saved locally as:
#> • /tmp/RtmpFGct9F/iris-242a1a8356bd.xlsx
```
