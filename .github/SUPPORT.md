...
Thanks for using googlesheets4. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/googlesheets4/issues) to make sure the 
