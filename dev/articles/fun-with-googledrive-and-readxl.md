...
#> [1] "/tmp/RtmpSS0x59/iris-26cc2821aa7e.csv"
...
#> Local file:
#> • /tmp/RtmpSS0x59/iris-26cc2821aa7e.csv
#> Uploaded into Drive file:
#> • iris-26cc2821aa7e <id: 15u3IQ0OQOEmlyQHHB9smupL2JAVBRpwvQU6fJVkKFoU>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26cc2821aa7e 15u3IQ0… <named list [37]>
...
#> ✔ Reading from iris-26cc2821aa7e.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpSS0x59/iris-26cc2821aa7e.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26cc2821aa7e <id: 15u3IQ0OQOEmlyQHHB9smupL2JAVBRpwvQU6fJVkKFoU>
#> Saved locally as:
#> • /tmp/RtmpSS0x59/iris-26cc2821aa7e.xlsx
```
