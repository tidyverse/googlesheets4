...
sheet_copy_internal <- function(ssid,
  ...
  gs4_bullets(c(v = "Duplicating sheet {.field {s$name}} in {.file {x$name}}"))
  ...
  gs4_bullets(c(v = "Copied as {.field {to_name}}"))
...
sheet_copy_external <- function(from_ssid,
  ...
  gs4_bullets(c(
    v = "Copying sheet {.field {from_s$name}} from \\
  ...
  if (is.null(index) && is.null(to_sheet)) {
    gs4_bullets(c(v = "Copied as {.field {to_s$title}}"))
  ...
  gs4_bullets(c(v = "Copied as {.field {to_sheet}}"))
