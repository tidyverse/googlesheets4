...
#> [1] "/tmp/RtmpzgpzT8/iris-256441e27299.csv"
...
#> Local file:
#> • /tmp/RtmpzgpzT8/iris-256441e27299.csv
#> Uploaded into Drive file:
#> • iris-256441e27299 <id: 1M6R501sHMmPZV0XLvC4kB-n9s6MgxMgQo5sz1McRE-4>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-256441e27299 1M6R501… <named list [37]>
...
#> ✔ Reading from iris-256441e27299.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpzgpzT8/iris-256441e27299.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-256441e27299 <id: 1M6R501sHMmPZV0XLvC4kB-n9s6MgxMgQo5sz1McRE-4>
#> Saved locally as:
#> • /tmp/RtmpzgpzT8/iris-256441e27299.xlsx
```
