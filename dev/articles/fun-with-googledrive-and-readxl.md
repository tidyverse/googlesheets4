...
#> [1] "/tmp/RtmpawCvEg/iris-24fd866606d.csv"
...
#> Local file:
#> • /tmp/RtmpawCvEg/iris-24fd866606d.csv
#> Uploaded into Drive file:
#> • iris-24fd866606d <id: 16A-ZbQrDfeEXzc1sB7QOnph_M5ZFFHUhInuyai0BicM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-24fd866606d 16A-ZbQ… <named list [38]>
...
#> ✔ Reading from iris-24fd866606d.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpawCvEg/iris-24fd866606d.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24fd866606d <id: 16A-ZbQrDfeEXzc1sB7QOnph_M5ZFFHUhInuyai0BicM>
#> Saved locally as:
#> • /tmp/RtmpawCvEg/iris-24fd866606d.xlsx
```
