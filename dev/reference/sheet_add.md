...
#> 1 eggplant        0  7.99e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.05e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  2.03e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.95e7 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.88e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  1.46e9 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1OlLqB8-iapLgxEU_WKK84UpVj7JlWVtjUCObJrc4Vso>
```
