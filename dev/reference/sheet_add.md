...
#> 3 apple           2  1.30e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.24e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  3.33e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.99e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  1.09e9 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1WXVLmaW6EVeQjYRRheVNBLtRCYRt6BK_MJLJewv291s>
```
