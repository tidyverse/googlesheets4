...
#> [1] "/tmp/RtmpMRfAMO/iris-2599a7ff59b.csv"
...
#> Local file:
#> • /tmp/RtmpMRfAMO/iris-2599a7ff59b.csv
#> Uploaded into Drive file:
#> • iris-2599a7ff59b <id: 1l0MyTiCvl1y_dzUxMO9xFOxLfnwCpXuwUVVXfOhZPh8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2599a7ff59b 1l0MyTi… <named list [38]>
...
#> ✔ Reading from iris-2599a7ff59b.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpMRfAMO/iris-2599a7ff59b.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2599a7ff59b <id: 1l0MyTiCvl1y_dzUxMO9xFOxLfnwCpXuwUVVXfOhZPh8>
#> Saved locally as:
#> • /tmp/RtmpMRfAMO/iris-2599a7ff59b.xlsx
```
