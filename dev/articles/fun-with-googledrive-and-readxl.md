...
#> [1] "/tmp/RtmpJhl3Bl/iris-24b87c896fb4.csv"
...
#> Local file:
#> • /tmp/RtmpJhl3Bl/iris-24b87c896fb4.csv
#> Uploaded into Drive file:
#> • iris-24b87c896fb4 <id: 1gT0VCtw_so4lpdz_pQ56IyghZrf3l_TQHX4XV_9g66o>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24b87c896fb4 1gT0VCt… <named list [38]>
...
#> ✔ Reading from iris-24b87c896fb4.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpJhl3Bl/iris-24b87c896fb4.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24b87c896fb4 <id: 1gT0VCtw_so4lpdz_pQ56IyghZrf3l_TQHX4XV_9g66o>
#> Saved locally as:
#> • /tmp/RtmpJhl3Bl/iris-24b87c896fb4.xlsx
```
