...
#> [1] "/tmp/RtmpPYNzqB/iris-26fc5077b20e.csv"
...
#> Local file:
#> • /tmp/RtmpPYNzqB/iris-26fc5077b20e.csv
#> Uploaded into Drive file:
#> • iris-26fc5077b20e <id: 1fWjZ-pOfbDTpbFhe4_1pyuz-lV0hSzyqjsxhegAr_Oc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26fc5077b20e 1fWjZ-p… <named list [37]>
...
#> ✔ Reading from iris-26fc5077b20e.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpPYNzqB/iris-26fc5077b20e.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26fc5077b20e <id: 1fWjZ-pOfbDTpbFhe4_1pyuz-lV0hSzyqjsxhegAr_Oc>
#> Saved locally as:
#> • /tmp/RtmpPYNzqB/iris-26fc5077b20e.xlsx
```
