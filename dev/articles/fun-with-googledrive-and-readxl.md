...
#> [1] "/tmp/RtmpTzK2cM/iris-25203cb7ddbf.csv"
...
#> Local file:
#> • /tmp/RtmpTzK2cM/iris-25203cb7ddbf.csv
#> Uploaded into Drive file:
#> • iris-25203cb7ddbf <id: 1SoEcBarlyuUiheGuMCPe8s7tNJTxtAkHTGCos0uvxic>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25203cb7ddbf 1SoEcBa… <named list [37]>
...
#> ✔ Reading from iris-25203cb7ddbf.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpTzK2cM/iris-25203cb7ddbf.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25203cb7ddbf <id: 1SoEcBarlyuUiheGuMCPe8s7tNJTxtAkHTGCos0uvxic>
#> Saved locally as:
#> • /tmp/RtmpTzK2cM/iris-25203cb7ddbf.xlsx
```
