...
#> [1] "/tmp/RtmpCvSlCV/iris-26a96b7394fd.csv"
...
#> Local file:
#> • /tmp/RtmpCvSlCV/iris-26a96b7394fd.csv
#> Uploaded into Drive file:
#> • iris-26a96b7394fd <id: 1whEYWWLYZZ2himDSEuWFcdf3rdMf4ckhjPoCVGyPf_w>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26a96b7394fd 1whEYWW… <named list [37]>
...
#> ✔ Reading from iris-26a96b7394fd.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpCvSlCV/iris-26a96b7394fd.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26a96b7394fd <id: 1whEYWWLYZZ2himDSEuWFcdf3rdMf4ckhjPoCVGyPf_w>
#> Saved locally as:
#> • /tmp/RtmpCvSlCV/iris-26a96b7394fd.xlsx
```
