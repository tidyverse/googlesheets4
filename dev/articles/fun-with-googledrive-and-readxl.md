...
#> [1] "/tmp/RtmpxMgIEF/iris-267a6bc6efd0.csv"
...
#> Local file:
#> • /tmp/RtmpxMgIEF/iris-267a6bc6efd0.csv
#> Uploaded into Drive file:
#> • iris-267a6bc6efd0 <id: 1xZg9tmZmLPtBfz420ALPNe3pbPBMeYUGApBqL_Z3Qxk>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-267a6bc6efd0 1xZg9tm… <named list [37]>
...
#> ✔ Reading from iris-267a6bc6efd0.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpxMgIEF/iris-267a6bc6efd0.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-267a6bc6efd0 <id: 1xZg9tmZmLPtBfz420ALPNe3pbPBMeYUGApBqL_Z3Qxk>
#> Saved locally as:
#> • /tmp/RtmpxMgIEF/iris-267a6bc6efd0.xlsx
```
