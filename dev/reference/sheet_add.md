...
#> 1 eggplant        0  5.66e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.63e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.93e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  8.13e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  5.50e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  6.32e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1kTVySf07tpESgs98zMs8zzeBrq6qnEc0Ab1ziSumhdQ>
```
