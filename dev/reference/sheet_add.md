...
#> 1 eggplant        0  3.62e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.39e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.46e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  3.27e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.07e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  7.80e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1Ti925VJo7rN0lY4z4oMY2kzC3pKBdPCQQj9QvhRfCdE>
```
