...
#> 1 eggplant        0  5.64e7 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  2.13e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.17e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.06e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.58e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  9.81e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1HlVnTH4uSgrOqp0f-XCM1nwkpcPQmGkhsKcwbB0Ywug>
```
