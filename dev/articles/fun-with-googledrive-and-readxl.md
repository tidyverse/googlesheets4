...
#> [1] "/tmp/RtmpH72N2o/iris-24a956341bb8.csv"
...
#> Local file:
#> • /tmp/RtmpH72N2o/iris-24a956341bb8.csv
#> Uploaded into Drive file:
#> • iris-24a956341bb8 <id: 1ZhoP7QyggVqtqeF7br34tYDaEwTA9eum7D_zQHbOphk>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24a956341bb8 1ZhoP7Q… <named list [37]>
...
#> ✔ Reading from iris-24a956341bb8.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpH72N2o/iris-24a956341bb8.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24a956341bb8 <id: 1ZhoP7QyggVqtqeF7br34tYDaEwTA9eum7D_zQHbOphk>
#> Saved locally as:
#> • /tmp/RtmpH72N2o/iris-24a956341bb8.xlsx
```
