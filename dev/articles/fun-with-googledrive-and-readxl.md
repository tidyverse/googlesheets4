...
#> [1] "/tmp/Rtmps4f63C/iris-24ae2a80883e.csv"
...
#> Local file:
#> • /tmp/Rtmps4f63C/iris-24ae2a80883e.csv
#> Uploaded into Drive file:
#> • iris-24ae2a80883e <id: 1WQyEJMWMdJfJbS1mRNrzpNoZhikCGJqmbtCcV2-cS-w>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24ae2a80883e 1WQyEJM… <named list [38]>
...
#> ✔ Reading from iris-24ae2a80883e.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmps4f63C/iris-24ae2a80883e.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24ae2a80883e <id: 1WQyEJMWMdJfJbS1mRNrzpNoZhikCGJqmbtCcV2-cS-w>
#> Saved locally as:
#> • /tmp/Rtmps4f63C/iris-24ae2a80883e.xlsx
```
