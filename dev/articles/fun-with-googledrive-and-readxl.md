...
#> [1] "/tmp/RtmpbyC7Gz/iris-2446168feda1.csv"
...
#> Local file:
#> • /tmp/RtmpbyC7Gz/iris-2446168feda1.csv
#> Uploaded into Drive file:
#> • iris-2446168feda1 <id: 1Qd-XZFxTs8fuaLBC_-TqAzaWGTU_C7rU9gKhrDYkvhI>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2446168feda1 1Qd-XZF… <named list [37]>
...
#> ✔ Reading from iris-2446168feda1.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpbyC7Gz/iris-2446168feda1.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2446168feda1 <id: 1Qd-XZFxTs8fuaLBC_-TqAzaWGTU_C7rU9gKhrDYkvhI>
#> Saved locally as:
#> • /tmp/RtmpbyC7Gz/iris-2446168feda1.xlsx
```
