...
#> [1] "/tmp/RtmpWfglQA/iris-248978affdd4.csv"
...
#> Local file:
#> • /tmp/RtmpWfglQA/iris-248978affdd4.csv
#> Uploaded into Drive file:
#> • iris-248978affdd4 <id: 1Zro11WdjIrPTuUeDlweZjya3aSDzbsEw5Qo3rlEmGdE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-248978affdd4 1Zro11W… <named list [37]>
...
#> ✔ Reading from iris-248978affdd4.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpWfglQA/iris-248978affdd4.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-248978affdd4 <id: 1Zro11WdjIrPTuUeDlweZjya3aSDzbsEw5Qo3rlEmGdE>
#> Saved locally as:
#> • /tmp/RtmpWfglQA/iris-248978affdd4.xlsx
```
