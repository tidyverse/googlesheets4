...
#> [1] "/tmp/RtmprwoJAt/iris-24db359ca777.csv"
...
#> Local file:
#> • /tmp/RtmprwoJAt/iris-24db359ca777.csv
#> Uploaded into Drive file:
#> • iris-24db359ca777 <id: 1SVY_u43eTwUjavt2awkfubvjc9jUE-DQiGTdJnECx7M>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24db359ca777 1SVY_u4… <named list [38]>
...
#> ✔ Reading from iris-24db359ca777.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmprwoJAt/iris-24db359ca777.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24db359ca777 <id: 1SVY_u43eTwUjavt2awkfubvjc9jUE-DQiGTdJnECx7M>
#> Saved locally as:
#> • /tmp/RtmprwoJAt/iris-24db359ca777.xlsx
```
