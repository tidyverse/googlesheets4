...
#> File trashed:
#> • heartsick-sealion <id: 1b_ssQZiormSNN1pHEhiSNVROJcWca_4jyhFAQBdVPGQ>
...
#> 1 alpha     0  520438514 GRID  TRUE            2            1 <NULL>
#> 2 omega     1  837631636 GRID  TRUE           33           11 <NULL>
#> 3 df        2 1825876372 GRID  TRUE            4            2 <NULL>
...
#> File trashed:
#> • sheet-write-demo <id: 11TslsL2LYYi1hkfZ-fhVPB8tOgUO9EF4RcyQsywDNM8>
```
