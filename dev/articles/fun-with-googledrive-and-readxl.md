...
#> [1] "/tmp/RtmpZRxcZJ/iris-24c6614af360.csv"
...
#> Local file:
#> • /tmp/RtmpZRxcZJ/iris-24c6614af360.csv
#> Uploaded into Drive file:
#> • iris-24c6614af360 <id: 1OAEgcbMse54nKPj_ZQ9v0NP5qDb4tBmNL8pre6J31HM>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24c6614af360 1OAEgcb… <named list [38]>
...
#> ✔ Reading from iris-24c6614af360.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpZRxcZJ/iris-24c6614af360.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24c6614af360 <id: 1OAEgcbMse54nKPj_ZQ9v0NP5qDb4tBmNL8pre6J31HM>
#> Saved locally as:
#> • /tmp/RtmpZRxcZJ/iris-24c6614af360.xlsx
```
