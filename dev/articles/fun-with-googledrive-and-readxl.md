...
#> [1] "/tmp/Rtmp99y2Zf/iris-25af7e2de7f6.csv"
...
#> Local file:
#> • /tmp/Rtmp99y2Zf/iris-25af7e2de7f6.csv
#> Uploaded into Drive file:
#> • iris-25af7e2de7f6 <id: 1BjSSwffjimnYbewYwYr94XoQlS9-FeO3tpUoJ_HwATc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25af7e2de7f6 1BjSSwf… <named list [37]>
...
#> ✔ Reading from iris-25af7e2de7f6.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp99y2Zf/iris-25af7e2de7f6.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25af7e2de7f6 <id: 1BjSSwffjimnYbewYwYr94XoQlS9-FeO3tpUoJ_HwATc>
#> Saved locally as:
#> • /tmp/Rtmp99y2Zf/iris-25af7e2de7f6.xlsx
```
