...
#> 1 eggplant        0  9.99e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  5.89e8 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  9.82e8 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  4.94e7 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  7.99e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  5.21e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1KZawzZ4P0PDvhf-1d71O95Q_TgedbYSO8HNwzl3V8_A>
```
