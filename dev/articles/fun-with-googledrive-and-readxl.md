...
#> [1] "/tmp/RtmptC105a/iris-248364467b0d.csv"
...
#> Local file:
#> • /tmp/RtmptC105a/iris-248364467b0d.csv
#> Uploaded into Drive file:
#> • iris-248364467b0d <id: 18RxzrrGVPo2b6MsO1FiDDXadcDm42ZWEYYZRcHxDn4o>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-248364467b0d 18Rxzrr… <named list [38]>
...
#> ✔ Reading from iris-248364467b0d.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmptC105a/iris-248364467b0d.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-248364467b0d <id: 18RxzrrGVPo2b6MsO1FiDDXadcDm42ZWEYYZRcHxDn4o>
#> Saved locally as:
#> • /tmp/RtmptC105a/iris-248364467b0d.xlsx
```
