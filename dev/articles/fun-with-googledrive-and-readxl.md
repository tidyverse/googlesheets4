...
#> [1] "/tmp/RtmpcRI77b/iris-251742a62f3b.csv"
...
#> Local file:
#> • /tmp/RtmpcRI77b/iris-251742a62f3b.csv
#> Uploaded into Drive file:
#> • iris-251742a62f3b <id: 1QlX9tZikJN-7ZkQekTHvgOtarhEqNtUCfouy5WuSl2o>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-251742a62f3b 1QlX9tZ… <named list [38]>
...
#> ✔ Reading from iris-251742a62f3b.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpcRI77b/iris-251742a62f3b.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-251742a62f3b <id: 1QlX9tZikJN-7ZkQekTHvgOtarhEqNtUCfouy5WuSl2o>
#> Saved locally as:
#> • /tmp/RtmpcRI77b/iris-251742a62f3b.xlsx
```
