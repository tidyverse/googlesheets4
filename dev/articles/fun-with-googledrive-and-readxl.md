...
#> [1] "/tmp/Rtmp9E4PTT/iris-24f03a867408.csv"
...
#> Local file:
#> • /tmp/Rtmp9E4PTT/iris-24f03a867408.csv
#> Uploaded into Drive file:
#> • iris-24f03a867408 <id: 1WOavO7kSKZdMTKHPLq5uW8qppmXV0aDcwM3CWus09EI>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24f03a867408 1WOavO7… <named list [38]>
...
#> ✔ Reading from iris-24f03a867408.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp9E4PTT/iris-24f03a867408.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24f03a867408 <id: 1WOavO7kSKZdMTKHPLq5uW8qppmXV0aDcwM3CWus09EI>
#> Saved locally as:
#> • /tmp/Rtmp9E4PTT/iris-24f03a867408.xlsx
```
