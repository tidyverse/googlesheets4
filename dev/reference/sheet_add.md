...
#> 3 apple           2  2.67e8 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  4.22e7 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.15e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.37e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  5.16e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1aS7za3jw0tR22iUZpYCQQKCd9vKF78M3mYnTXWFXfPM>
```
