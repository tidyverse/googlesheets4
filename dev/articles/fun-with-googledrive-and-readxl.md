...
#> [1] "/tmp/RtmpioH036/iris-24e33471886d.csv"
...
#> Local file:
#> • /tmp/RtmpioH036/iris-24e33471886d.csv
#> Uploaded into Drive file:
#> • iris-24e33471886d <id: 1ShYuCdQoEG10Y_OmPtsJwQxhxrluVPnXgWHepzs1ctk>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24e33471886d 1ShYuCd… <named list [38]>
...
#> ✔ Reading from iris-24e33471886d.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpioH036/iris-24e33471886d.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24e33471886d <id: 1ShYuCdQoEG10Y_OmPtsJwQxhxrluVPnXgWHepzs1ctk>
#> Saved locally as:
#> • /tmp/RtmpioH036/iris-24e33471886d.xlsx
```
