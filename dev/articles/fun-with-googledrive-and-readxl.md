...
#> [1] "/tmp/RtmpMsIZNO/iris-24a429e1aba7.csv"
...
#> Local file:
#> • /tmp/RtmpMsIZNO/iris-24a429e1aba7.csv
#> Uploaded into Drive file:
#> • iris-24a429e1aba7 <id: 1bjLF0i9Ndv6Y1icXg_fF59sEMS04Pq7ciM2wqtOrmF4>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24a429e1aba7 1bjLF0i… <named list [37]>
...
#> ✔ Reading from iris-24a429e1aba7.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpMsIZNO/iris-24a429e1aba7.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24a429e1aba7 <id: 1bjLF0i9Ndv6Y1icXg_fF59sEMS04Pq7ciM2wqtOrmF4>
#> Saved locally as:
#> • /tmp/RtmpMsIZNO/iris-24a429e1aba7.xlsx
```
