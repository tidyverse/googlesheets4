...
#> [1] "/tmp/RtmpLDQYMs/iris-24cc5adad32.csv"
...
#> Local file:
#> • /tmp/RtmpLDQYMs/iris-24cc5adad32.csv
#> Uploaded into Drive file:
#> • iris-24cc5adad32 <id: 1n2YwTVJXKewJKSqMipSM3f14XGmFhcyMvTz_bjw6Vvc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-24cc5adad32 1n2YwTV… <named list [38]>
...
#> ✔ Reading from iris-24cc5adad32.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpLDQYMs/iris-24cc5adad32.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24cc5adad32 <id: 1n2YwTVJXKewJKSqMipSM3f14XGmFhcyMvTz_bjw6Vvc>
#> Saved locally as:
#> • /tmp/RtmpLDQYMs/iris-24cc5adad32.xlsx
```
