...
#> 1 eggplant        0  4.58e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.41e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  4.33e8 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  1.96e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  5.31e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  1.03e9 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1eKlKlddvEqau0zMtEOqygMdssG0CV-ZN0Dhm1PhdZeQ>
```
