...
#> [1] "/tmp/RtmpJWTy6i/iris-26c378d9b358.csv"
...
#> Local file:
#> • /tmp/RtmpJWTy6i/iris-26c378d9b358.csv
#> Uploaded into Drive file:
#> • iris-26c378d9b358 <id: 1VsSAAH3lSqEmH8uR2qPws1a_R9UTEewehTHh_u8d33I>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26c378d9b358 1VsSAAH… <named list [37]>
...
#> ✔ Reading from iris-26c378d9b358.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpJWTy6i/iris-26c378d9b358.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26c378d9b358 <id: 1VsSAAH3lSqEmH8uR2qPws1a_R9UTEewehTHh_u8d33I>
#> Saved locally as:
#> • /tmp/RtmpJWTy6i/iris-26c378d9b358.xlsx
```
