...
#> [1] "/tmp/RtmphZRHxm/iris-247c7e95d4e3.csv"
...
#> Local file:
#> • /tmp/RtmphZRHxm/iris-247c7e95d4e3.csv
#> Uploaded into Drive file:
#> • iris-247c7e95d4e3 <id: 1srEKt2RzhH34nWOTl9md2tmCrF3RaxdoccMk65NM8QE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-247c7e95d4e3 1srEKt2… <named list [37]>
...
#> ✔ Reading from iris-247c7e95d4e3.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmphZRHxm/iris-247c7e95d4e3.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-247c7e95d4e3 <id: 1srEKt2RzhH34nWOTl9md2tmCrF3RaxdoccMk65NM8QE>
#> Saved locally as:
#> • /tmp/RtmphZRHxm/iris-247c7e95d4e3.xlsx
```
