...
#> [1] "/tmp/RtmpM67miE/iris-250236f6198.csv"
...
#> Local file:
#> • /tmp/RtmpM67miE/iris-250236f6198.csv
#> Uploaded into Drive file:
#> • iris-250236f6198 <id: 1zzliVbCoafTQSRST1Gc5zlyjlltSylzSC5m6ipLDOME>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-250236f6198 1zzliVb… <named list [38]>
...
#> ✔ Reading from iris-250236f6198.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpM67miE/iris-250236f6198.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-250236f6198 <id: 1zzliVbCoafTQSRST1Gc5zlyjlltSylzSC5m6ipLDOME>
#> Saved locally as:
#> • /tmp/RtmpM67miE/iris-250236f6198.xlsx
```
