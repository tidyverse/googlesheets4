...
#> 1 eggplant        0  1.78e9 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  1.63e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  8.73e7 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  4.93e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.82e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  3.46e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 19GDqeQrW9oXQFpODw_4_lqDzqasSUPawje-LsU_UvpA>
```
