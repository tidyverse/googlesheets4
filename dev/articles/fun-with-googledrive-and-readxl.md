...
#> [1] "/tmp/RtmpLnGph7/iris-2583267bdcab.csv"
...
#> Local file:
#> • /tmp/RtmpLnGph7/iris-2583267bdcab.csv
#> Uploaded into Drive file:
#> • iris-2583267bdcab <id: 1bzphTDQPigj0wjoqgXKYcmJPy3YeouNQergBa8XlTpw>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2583267bdcab 1bzphTD… <named list [37]>
...
#> ✔ Reading from iris-2583267bdcab.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpLnGph7/iris-2583267bdcab.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2583267bdcab <id: 1bzphTDQPigj0wjoqgXKYcmJPy3YeouNQergBa8XlTpw>
#> Saved locally as:
#> • /tmp/RtmpLnGph7/iris-2583267bdcab.xlsx
```
