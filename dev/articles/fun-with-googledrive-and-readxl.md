...
#> [1] "/tmp/RtmpVIjgO2/iris-26f8269fdd7f.csv"
...
#> Local file:
#> • /tmp/RtmpVIjgO2/iris-26f8269fdd7f.csv
#> Uploaded into Drive file:
#> • iris-26f8269fdd7f <id: 1jPo9P4x1f_jUpOUve8io-6w36DJBSQyL_WQf9XMZA0Q>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-26f8269fdd7f 1jPo9P4… <named list [37]>
...
#> ✔ Reading from iris-26f8269fdd7f.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpVIjgO2/iris-26f8269fdd7f.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26f8269fdd7f <id: 1jPo9P4x1f_jUpOUve8io-6w36DJBSQyL_WQf9XMZA0Q>
#> Saved locally as:
#> • /tmp/RtmpVIjgO2/iris-26f8269fdd7f.xlsx
```
