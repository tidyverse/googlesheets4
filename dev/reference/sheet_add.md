...
#> 3 apple           2  2.08e9 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.33e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  9.30e8 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  6.01e8 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  1.51e9 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 10WQgMV8Hgf9TxCT2-5367_SHHgNeWkJs9q2UaPF305I>
```
