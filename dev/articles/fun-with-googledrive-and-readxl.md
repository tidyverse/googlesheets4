...
#> [1] "/tmp/RtmpynURWa/iris-23e5eb74af8.csv"
...
#> Local file:
#> • /tmp/RtmpynURWa/iris-23e5eb74af8.csv
#> Uploaded into Drive file:
#> • iris-23e5eb74af8 <id: 1T5aKMwNWn6dCPYPkqV--Oz_zbWaufiM7ru42hs54hQA>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-23e5eb74af8 1T5aKMw… <named list [37]>
...
#> ✔ Reading from iris-23e5eb74af8.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpynURWa/iris-23e5eb74af8.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-23e5eb74af8 <id: 1T5aKMwNWn6dCPYPkqV--Oz_zbWaufiM7ru42hs54hQA>
#> Saved locally as:
#> • /tmp/RtmpynURWa/iris-23e5eb74af8.xlsx
```
