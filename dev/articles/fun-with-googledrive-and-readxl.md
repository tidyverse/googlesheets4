...
#> [1] "/tmp/RtmpXTn0sF/iris-25021fe3a4cd.csv"
...
#> Local file:
#> • /tmp/RtmpXTn0sF/iris-25021fe3a4cd.csv
#> Uploaded into Drive file:
#> • iris-25021fe3a4cd <id: 1qhxaimV_g9eCHA-Qo44BjLk1n3Js3ZVjfRXmjyIofnw>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25021fe3a4cd 1qhxaim… <named list [37]>
...
#> ✔ Reading from iris-25021fe3a4cd.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpXTn0sF/iris-25021fe3a4cd.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25021fe3a4cd <id: 1qhxaimV_g9eCHA-Qo44BjLk1n3Js3ZVjfRXmjyIofnw>
#> Saved locally as:
#> • /tmp/RtmpXTn0sF/iris-25021fe3a4cd.xlsx
```
