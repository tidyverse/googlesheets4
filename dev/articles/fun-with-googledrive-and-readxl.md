...
#> [1] "/tmp/RtmpJHMibr/iris-255d564a8aca.csv"
...
#> Local file:
#> • /tmp/RtmpJHMibr/iris-255d564a8aca.csv
#> Uploaded into Drive file:
#> • iris-255d564a8aca <id: 12G0vHqIniyJx1Aw_8eF9Hd7hwJ5V1VN3hH_9-WihBYg>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-255d564a8aca 12G0vHq… <named list [38]>
...
#> ✔ Reading from iris-255d564a8aca.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpJHMibr/iris-255d564a8aca.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-255d564a8aca <id: 12G0vHqIniyJx1Aw_8eF9Hd7hwJ5V1VN3hH_9-WihBYg>
#> Saved locally as:
#> • /tmp/RtmpJHMibr/iris-255d564a8aca.xlsx
```
