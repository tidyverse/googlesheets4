...
#> [1] "/tmp/Rtmpkeqe1s/iris-24885742f00.csv"
...
#> Local file:
#> • /tmp/Rtmpkeqe1s/iris-24885742f00.csv
#> Uploaded into Drive file:
#> • iris-24885742f00 <id: 1Bn73vnkEmbt-uh4_QnoIJjTwGtHxDdmmzIzijrFcCfA>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-24885742f00 1Bn73vn… <named list [38]>
...
#> ✔ Reading from iris-24885742f00.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpkeqe1s/iris-24885742f00.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24885742f00 <id: 1Bn73vnkEmbt-uh4_QnoIJjTwGtHxDdmmzIzijrFcCfA>
#> Saved locally as:
#> • /tmp/Rtmpkeqe1s/iris-24885742f00.xlsx
```
