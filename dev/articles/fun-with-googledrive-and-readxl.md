...
#> [1] "/tmp/Rtmpw6cxpG/iris-266133c3366f.csv"
...
#> Local file:
#> • /tmp/Rtmpw6cxpG/iris-266133c3366f.csv
#> Uploaded into Drive file:
#> • iris-266133c3366f <id: 1iNxqg36mBeODf1vr1-wAnLjkmE427la4YzM9oNSaS44>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-266133c3366f 1iNxqg3… <named list [37]>
...
#> ✔ Reading from iris-266133c3366f.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpw6cxpG/iris-266133c3366f.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-266133c3366f <id: 1iNxqg36mBeODf1vr1-wAnLjkmE427la4YzM9oNSaS44>
#> Saved locally as:
#> • /tmp/Rtmpw6cxpG/iris-266133c3366f.xlsx
```
