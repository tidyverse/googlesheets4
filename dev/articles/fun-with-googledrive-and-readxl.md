...
#> [1] "/tmp/RtmpbDnoWL/iris-24d293234fa.csv"
...
#> Local file:
#> • /tmp/RtmpbDnoWL/iris-24d293234fa.csv
#> Uploaded into Drive file:
#> • iris-24d293234fa <id: 1lgLhMu8L-rBv4TyiYuzDFdotlwiTvmQbBAGc2DCqWwc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-24d293234fa 1lgLhMu… <named list [37]>
...
#> [1] "/tmp/RtmpbDnoWL/iris-24d293234fa.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24d293234fa <id: 1lgLhMu8L-rBv4TyiYuzDFdotlwiTvmQbBAGc2DCqWwc>
#> Saved locally as:
#> • /tmp/RtmpbDnoWL/iris-24d293234fa.xlsx
```
