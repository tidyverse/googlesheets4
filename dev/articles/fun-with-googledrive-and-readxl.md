...
#> [1] "/tmp/RtmpnzE6to/iris-24f34ea451c7.csv"
...
#> Local file:
#> • /tmp/RtmpnzE6to/iris-24f34ea451c7.csv
#> Uploaded into Drive file:
#> • iris-24f34ea451c7 <id: 1zZhsK3Yv8YoCPGXdOyNIOjIyvLKX-R8tln_wgMC7k9k>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24f34ea451c7 1zZhsK3… <named list [37]>
...
#> ✔ Reading from iris-24f34ea451c7.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpnzE6to/iris-24f34ea451c7.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24f34ea451c7 <id: 1zZhsK3Yv8YoCPGXdOyNIOjIyvLKX-R8tln_wgMC7k9k>
#> Saved locally as:
#> • /tmp/RtmpnzE6to/iris-24f34ea451c7.xlsx
```
