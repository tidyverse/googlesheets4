...
#> [1] "/tmp/RtmprBtL0W/iris-27187fdc2038.csv"
...
#> Local file:
#> • /tmp/RtmprBtL0W/iris-27187fdc2038.csv
#> Uploaded into Drive file:
#> • iris-27187fdc2038 <id: 1ut--RjpX3MBcezN8W1Y9F8zt-JkNEN8EUsIR1i12hwk>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-27187fdc2038 1ut--Rj… <named list [37]>
...
#> ✔ Reading from iris-27187fdc2038.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmprBtL0W/iris-27187fdc2038.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-27187fdc2038 <id: 1ut--RjpX3MBcezN8W1Y9F8zt-JkNEN8EUsIR1i12hwk>
#> Saved locally as:
#> • /tmp/RtmprBtL0W/iris-27187fdc2038.xlsx
```
