...
Thanks for using googlesheets4! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/tidyverse/googlesheets4/issues/new).
...
requests](https://github.com/tidyverse/googlesheets4/issues) to make
