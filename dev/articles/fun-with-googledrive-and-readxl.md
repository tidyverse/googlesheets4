...
#> [1] "/tmp/RtmpXwC4sG/iris-25c359d33f10.csv"
...
#> Local file:
#> • /tmp/RtmpXwC4sG/iris-25c359d33f10.csv
#> Uploaded into Drive file:
#> • iris-25c359d33f10 <id: 1j-CtgJx4PVfaZaRF-DcFlPjlzT20Fx65-84pq7ZUWXw>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25c359d33f10 1j-CtgJ… <named list [38]>
...
#> ✔ Reading from iris-25c359d33f10.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpXwC4sG/iris-25c359d33f10.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25c359d33f10 <id: 1j-CtgJx4PVfaZaRF-DcFlPjlzT20Fx65-84pq7ZUWXw>
#> Saved locally as:
#> • /tmp/RtmpXwC4sG/iris-25c359d33f10.xlsx
```
