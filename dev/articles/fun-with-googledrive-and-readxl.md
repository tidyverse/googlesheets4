...
#> [1] "/tmp/Rtmpl3tPGk/iris-25c47306e754.csv"
...
#> Local file:
#> • /tmp/Rtmpl3tPGk/iris-25c47306e754.csv
#> Uploaded into Drive file:
#> • iris-25c47306e754 <id: 1t13SrcbpdSnGrlPgHJaVvxHF8_298tbEaqfTYHqCthE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25c47306e754 1t13Src… <named list [38]>
...
#> ✔ Reading from iris-25c47306e754.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpl3tPGk/iris-25c47306e754.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25c47306e754 <id: 1t13SrcbpdSnGrlPgHJaVvxHF8_298tbEaqfTYHqCthE>
#> Saved locally as:
#> • /tmp/Rtmpl3tPGk/iris-25c47306e754.xlsx
```
