...
#> [1] "/tmp/Rtmp2uDXnW/iris-24c325988122.csv"
...
#> Local file:
#> • /tmp/Rtmp2uDXnW/iris-24c325988122.csv
#> Uploaded into Drive file:
#> • iris-24c325988122 <id: 1E1ZGdaxUM7mwwg-YtnEgWlyY9RUbYBGVeY0_IBaah8k>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24c325988122 1E1ZGda… <named list [38]>
...
#> ✔ Reading from iris-24c325988122.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp2uDXnW/iris-24c325988122.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24c325988122 <id: 1E1ZGdaxUM7mwwg-YtnEgWlyY9RUbYBGVeY0_IBaah8k>
#> Saved locally as:
#> • /tmp/Rtmp2uDXnW/iris-24c325988122.xlsx
```
