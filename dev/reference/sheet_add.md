...
#> 1 eggplant        0  5.99e8 GRID  TRUE            3            6 <NULL>
#> 2 Sheet1          1  0      GRID  TRUE         1000           26 <NULL>
#> 3 apple           2  6.08e8 GRID  TRUE         1000           26 <NULL>
#> 4 banana          3  1.75e9 GRID  TRUE         1000           26 <NULL>
#> 5 Sheet2          4  2.00e9 GRID  TRUE         1000           26 <NULL>
#> 6 coconut         5  1.83e9 GRID  TRUE         1000           26 <NULL>
#> 7 dragonfruit     6  1.73e8 GRID  TRUE         1000           26 <NULL>

# clean up
gs4_find("add-sheets-to-me") %>%
  googledrive::drive_trash()
#> File trashed:
#> • add-sheets-to-me <id: 1fg_yqY7Txe_k0q9FeTRigwBeuXYPiJ9gC3zBOAGxOI4>
```
