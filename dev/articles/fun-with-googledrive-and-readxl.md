...
#> [1] "/tmp/Rtmpd4Q4Ve/iris-2819a5e7afd.csv"
...
#> Local file:
#> • /tmp/Rtmpd4Q4Ve/iris-2819a5e7afd.csv
#> Uploaded into Drive file:
#> • iris-2819a5e7afd <id: 1w3XbDebZvVjQF0iGfbFekdhyUAV2cYZ5gpnyhB11PUc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2819a5e7afd 1w3XbDe… <named list [37]>
...
#> ✔ Reading from iris-2819a5e7afd.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpd4Q4Ve/iris-2819a5e7afd.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2819a5e7afd <id: 1w3XbDebZvVjQF0iGfbFekdhyUAV2cYZ5gpnyhB11PUc>
#> Saved locally as:
#> • /tmp/Rtmpd4Q4Ve/iris-2819a5e7afd.xlsx
```
