...
#> [1] "/tmp/RtmpuWjCj5/iris-254b43c3a86.csv"
...
#> Local file:
#> • /tmp/RtmpuWjCj5/iris-254b43c3a86.csv
#> Uploaded into Drive file:
#> • iris-254b43c3a86 <id: 1VNYxRJImZnAwQ8lmwSAvP7z9AWrpEI8SqeDFUP-n3KE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-254b43c3a86 1VNYxRJ… <named list [38]>
...
#> ✔ Reading from iris-254b43c3a86.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpuWjCj5/iris-254b43c3a86.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-254b43c3a86 <id: 1VNYxRJImZnAwQ8lmwSAvP7z9AWrpEI8SqeDFUP-n3KE>
#> Saved locally as:
#> • /tmp/RtmpuWjCj5/iris-254b43c3a86.xlsx
```
