...
#> [1] "/tmp/RtmpwhlzqD/iris-2527470242af.csv"
...
#> Local file:
#> • /tmp/RtmpwhlzqD/iris-2527470242af.csv
#> Uploaded into Drive file:
#> • iris-2527470242af <id: 1a2tzNoXfJyqM-vPnaYU13bk74kg89je13TF3hqGajpI>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2527470242af 1a2tzNo… <named list [37]>
...
#> ✔ Reading from iris-2527470242af.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpwhlzqD/iris-2527470242af.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2527470242af <id: 1a2tzNoXfJyqM-vPnaYU13bk74kg89je13TF3hqGajpI>
#> Saved locally as:
#> • /tmp/RtmpwhlzqD/iris-2527470242af.xlsx
```
