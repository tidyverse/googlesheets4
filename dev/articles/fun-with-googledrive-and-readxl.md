...
#> [1] "/tmp/RtmpPZW0RG/iris-24e52a4e6676.csv"
...
#> Local file:
#> • /tmp/RtmpPZW0RG/iris-24e52a4e6676.csv
#> Uploaded into Drive file:
#> • iris-24e52a4e6676 <id: 1YsdxOKTGCQuOCbDC_fS3F_p0xFsMYdH9Yfnoopg8Jg0>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24e52a4e6676 1YsdxOK… <named list [39]>
...
#> ✔ Reading from iris-24e52a4e6676.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpPZW0RG/iris-24e52a4e6676.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24e52a4e6676 <id: 1YsdxOKTGCQuOCbDC_fS3F_p0xFsMYdH9Yfnoopg8Jg0>
#> Saved locally as:
#> • /tmp/RtmpPZW0RG/iris-24e52a4e6676.xlsx
```
