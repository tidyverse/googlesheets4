...
#> [1] "/tmp/RtmpOgOLgz/iris-26f9485993e.csv"
...
#> Local file:
#> • /tmp/RtmpOgOLgz/iris-26f9485993e.csv
#> Uploaded into Drive file:
#> • iris-26f9485993e <id: 1U8enZmC3QqankGeoH9zRgWnJgUObuSt0FpG6F5VwnHc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-26f9485993e 1U8enZm… <named list [37]>
...
#> ✔ Reading from iris-26f9485993e.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpOgOLgz/iris-26f9485993e.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-26f9485993e <id: 1U8enZmC3QqankGeoH9zRgWnJgUObuSt0FpG6F5VwnHc>
#> Saved locally as:
#> • /tmp/RtmpOgOLgz/iris-26f9485993e.xlsx
```
