...
#> [1] "/tmp/RtmpVj843a/iris-251f86debc5.csv"
...
#> Local file:
#> • /tmp/RtmpVj843a/iris-251f86debc5.csv
#> Uploaded into Drive file:
#> • iris-251f86debc5 <id: 17PSVRiHZPRE6GOuXdgZbYg3EZrEAVQ4FaaOmKFqN-eg>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-251f86debc5 17PSVRi… <named list [38]>
...
#> ✔ Reading from iris-251f86debc5.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpVj843a/iris-251f86debc5.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-251f86debc5 <id: 17PSVRiHZPRE6GOuXdgZbYg3EZrEAVQ4FaaOmKFqN-eg>
#> Saved locally as:
#> • /tmp/RtmpVj843a/iris-251f86debc5.xlsx
```
