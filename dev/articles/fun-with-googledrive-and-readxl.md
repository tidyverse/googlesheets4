...
#> [1] "/tmp/RtmpbOEshE/iris-24af3ff55bb0.csv"
...
#> Local file:
#> • /tmp/RtmpbOEshE/iris-24af3ff55bb0.csv
#> Uploaded into Drive file:
#> • iris-24af3ff55bb0 <id: 1jLgc2ugKgZWvwSO-Xv2-pbGkPblVr_Lq0D9OwoeUo1M>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24af3ff55bb0 1jLgc2u… <named list [38]>
...
#> ✔ Reading from iris-24af3ff55bb0.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpbOEshE/iris-24af3ff55bb0.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24af3ff55bb0 <id: 1jLgc2ugKgZWvwSO-Xv2-pbGkPblVr_Lq0D9OwoeUo1M>
#> Saved locally as:
#> • /tmp/RtmpbOEshE/iris-24af3ff55bb0.xlsx
```
