...
#> [1] "/tmp/RtmpQdriEW/iris-25203de35669.csv"
...
#> Local file:
#> • /tmp/RtmpQdriEW/iris-25203de35669.csv
#> Uploaded into Drive file:
#> • iris-25203de35669 <id: 1Auhx_ts78JCijTx5wS8FojI52QwTESoVApW_qWmyMkE>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25203de35669 1Auhx_t… <named list [38]>
...
#> ✔ Reading from iris-25203de35669.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpQdriEW/iris-25203de35669.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25203de35669 <id: 1Auhx_ts78JCijTx5wS8FojI52QwTESoVApW_qWmyMkE>
#> Saved locally as:
#> • /tmp/RtmpQdriEW/iris-25203de35669.xlsx
```
