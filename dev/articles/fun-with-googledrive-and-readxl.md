...
#> [1] "/tmp/RtmpLcGPKF/iris-27df477a5895.csv"
...
#> Local file:
#> • /tmp/RtmpLcGPKF/iris-27df477a5895.csv
#> Uploaded into Drive file:
#> • iris-27df477a5895 <id: 17lzCbK6bx93Qx16ptPlfAKKL18k3Go_zssV5YmM3S48>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-27df477a5895 17lzCbK… <named list [38]>
...
#> ✔ Reading from iris-27df477a5895.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpLcGPKF/iris-27df477a5895.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-27df477a5895 <id: 17lzCbK6bx93Qx16ptPlfAKKL18k3Go_zssV5YmM3S48>
#> Saved locally as:
#> • /tmp/RtmpLcGPKF/iris-27df477a5895.xlsx
```
