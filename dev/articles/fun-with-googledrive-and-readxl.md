...
#> [1] "/tmp/Rtmpp8s3xM/iris-27d7243b96a0.csv"
...
#> Local file:
#> • /tmp/Rtmpp8s3xM/iris-27d7243b96a0.csv
#> Uploaded into Drive file:
#> • iris-27d7243b96a0 <id: 1_dffHdmBxv9mvdC9MoSao_EcaT8A0Ya7vaQkdtYEmyc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-27d7243b96a0 1_dffHd… <named list [38]>
...
#> ✔ Reading from iris-27d7243b96a0.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmpp8s3xM/iris-27d7243b96a0.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-27d7243b96a0 <id: 1_dffHdmBxv9mvdC9MoSao_EcaT8A0Ya7vaQkdtYEmyc>
#> Saved locally as:
#> • /tmp/Rtmpp8s3xM/iris-27d7243b96a0.xlsx
```
