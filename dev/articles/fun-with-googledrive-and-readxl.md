...
#> [1] "/tmp/RtmpufDDGl/iris-25154af1c0c1.csv"
...
#> Local file:
#> • /tmp/RtmpufDDGl/iris-25154af1c0c1.csv
#> Uploaded into Drive file:
#> • iris-25154af1c0c1 <id: 12GYEKTwDFC96QiWvPs8hhH4hF323HjeSJqgwnMqVOD4>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25154af1c0c1 12GYEKT… <named list [37]>
...
#> ✔ Reading from iris-25154af1c0c1.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpufDDGl/iris-25154af1c0c1.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25154af1c0c1 <id: 12GYEKTwDFC96QiWvPs8hhH4hF323HjeSJqgwnMqVOD4>
#> Saved locally as:
#> • /tmp/RtmpufDDGl/iris-25154af1c0c1.xlsx
```
