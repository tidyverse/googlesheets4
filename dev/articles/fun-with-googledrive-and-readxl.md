...
#> [1] "/tmp/Rtmp0V1toC/iris-25b76cbec641.csv"
...
#> Local file:
#> • /tmp/Rtmp0V1toC/iris-25b76cbec641.csv
#> Uploaded into Drive file:
#> • iris-25b76cbec641 <id: 1I9kqDiNfJxn3uOF0DDXNW-ZtNbHKyCyWut0tiwOROT4>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-25b76cbec641 1I9kqDi… <named list [38]>
...
#> ✔ Reading from iris-25b76cbec641.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp0V1toC/iris-25b76cbec641.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-25b76cbec641 <id: 1I9kqDiNfJxn3uOF0DDXNW-ZtNbHKyCyWut0tiwOROT4>
#> Saved locally as:
#> • /tmp/Rtmp0V1toC/iris-25b76cbec641.xlsx
```
