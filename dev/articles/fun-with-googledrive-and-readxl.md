...
#> [1] "/tmp/RtmpzUN7Ow/iris-2460c20d794.csv"
...
#> Local file:
#> • /tmp/RtmpzUN7Ow/iris-2460c20d794.csv
#> Uploaded into Drive file:
#> • iris-2460c20d794 <id: 1C5-xhq5soCImYOqkwBN1O9OxHohooOOX1KKVkgirea8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2460c20d794 1C5-xhq… <named list [38]>
...
#> ✔ Reading from iris-2460c20d794.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpzUN7Ow/iris-2460c20d794.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2460c20d794 <id: 1C5-xhq5soCImYOqkwBN1O9OxHohooOOX1KKVkgirea8>
#> Saved locally as:
#> • /tmp/RtmpzUN7Ow/iris-2460c20d794.xlsx
```
