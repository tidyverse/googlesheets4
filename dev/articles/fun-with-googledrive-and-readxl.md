...
#> [1] "/tmp/RtmpWs9fHb/iris-259b54dc082f.csv"
...
#> Local file:
#> • /tmp/RtmpWs9fHb/iris-259b54dc082f.csv
#> Uploaded into Drive file:
#> • iris-259b54dc082f <id: 1Qr3brVOx2Ki2ajVVYOIJqXmuLGdiLRJkKo9hZBzXU3k>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-259b54dc082f 1Qr3brV… <named list [38]>
...
#> ✔ Reading from iris-259b54dc082f.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpWs9fHb/iris-259b54dc082f.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-259b54dc082f <id: 1Qr3brVOx2Ki2ajVVYOIJqXmuLGdiLRJkKo9hZBzXU3k>
#> Saved locally as:
#> • /tmp/RtmpWs9fHb/iris-259b54dc082f.xlsx
```
