...
#> [1] "/tmp/Rtmps8XzER/iris-2688bd4185f.csv"
...
#> Local file:
#> • /tmp/Rtmps8XzER/iris-2688bd4185f.csv
#> Uploaded into Drive file:
#> • iris-2688bd4185f <id: 155wxd5qBGZuBghUhnoze4IRiZKJ2RpO4d1xcuUOqhWg>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2688bd4185f 155wxd5… <named list [37]>
...
#> ✔ Reading from iris-2688bd4185f.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmps8XzER/iris-2688bd4185f.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2688bd4185f <id: 155wxd5qBGZuBghUhnoze4IRiZKJ2RpO4d1xcuUOqhWg>
#> Saved locally as:
#> • /tmp/Rtmps8XzER/iris-2688bd4185f.xlsx
```
