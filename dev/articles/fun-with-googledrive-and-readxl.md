...
#> [1] "/tmp/RtmpZFDGIj/iris-2678218e3d28.csv"
...
#> Local file:
#> • /tmp/RtmpZFDGIj/iris-2678218e3d28.csv
#> Uploaded into Drive file:
#> • iris-2678218e3d28 <id: 16LA69keTjMgtHKzLKjFO8tJ9j_z4sYWg3lEm0Zw5Wrk>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-2678218e3d28 16LA69k… <named list [38]>
...
#> ✔ Reading from iris-2678218e3d28.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpZFDGIj/iris-2678218e3d28.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2678218e3d28 <id: 16LA69keTjMgtHKzLKjFO8tJ9j_z4sYWg3lEm0Zw5Wrk>
#> Saved locally as:
#> • /tmp/RtmpZFDGIj/iris-2678218e3d28.xlsx
```
