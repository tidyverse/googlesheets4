...
#> [1] "/tmp/RtmplUtG5m/iris-24ce3c84e4d9.csv"
...
#> Local file:
#> • /tmp/RtmplUtG5m/iris-24ce3c84e4d9.csv
#> Uploaded into Drive file:
#> • iris-24ce3c84e4d9 <id: 1fWyNKKHL3FHX3Re_86VjuylOzwku6MAnTqdYJFhHjZU>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24ce3c84e4d9 1fWyNKK… <named list [38]>
...
#> ✔ Reading from iris-24ce3c84e4d9.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmplUtG5m/iris-24ce3c84e4d9.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24ce3c84e4d9 <id: 1fWyNKKHL3FHX3Re_86VjuylOzwku6MAnTqdYJFhHjZU>
#> Saved locally as:
#> • /tmp/RtmplUtG5m/iris-24ce3c84e4d9.xlsx
```
