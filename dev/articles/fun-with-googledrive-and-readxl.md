...
#> [1] "/tmp/RtmpcEiKhq/iris-24de132ff8c2.csv"
...
#> Local file:
#> • /tmp/RtmpcEiKhq/iris-24de132ff8c2.csv
#> Uploaded into Drive file:
#> • iris-24de132ff8c2 <id: 10HqKfDR_XeDfL-mtna0PrMeG9MxkTXH6wfxaxu0TS2w>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-24de132ff8c2 10HqKfD… <named list [37]>
...
#> ✔ Reading from iris-24de132ff8c2.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpcEiKhq/iris-24de132ff8c2.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-24de132ff8c2 <id: 10HqKfDR_XeDfL-mtna0PrMeG9MxkTXH6wfxaxu0TS2w>
#> Saved locally as:
#> • /tmp/RtmpcEiKhq/iris-24de132ff8c2.xlsx
```
