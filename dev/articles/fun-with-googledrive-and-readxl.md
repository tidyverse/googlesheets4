...
#> [1] "/tmp/RtmpZ3BP8t/iris-249e3e917542.csv"
...
#> Local file:
#> • /tmp/RtmpZ3BP8t/iris-249e3e917542.csv
#> Uploaded into Drive file:
#> • iris-249e3e917542 <id: 1ya4v4uu0LIviNBFmcEEIIJWvTjUQ94s8SHZa4XWCDW8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-249e3e917542 1ya4v4u… <named list [37]>
...
#> ✔ Reading from iris-249e3e917542.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpZ3BP8t/iris-249e3e917542.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-249e3e917542 <id: 1ya4v4uu0LIviNBFmcEEIIJWvTjUQ94s8SHZa4XWCDW8>
#> Saved locally as:
#> • /tmp/RtmpZ3BP8t/iris-249e3e917542.xlsx
```
