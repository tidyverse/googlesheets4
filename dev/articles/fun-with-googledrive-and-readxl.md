...
#> [1] "/tmp/Rtmp07N9c8/iris-254e727121be.csv"
...
#> Local file:
#> • /tmp/Rtmp07N9c8/iris-254e727121be.csv
#> Uploaded into Drive file:
#> • iris-254e727121be <id: 1gXlO8rAY0cKQAqvC6HON-iElFYVjNvlh3kBJ1W655a8>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-254e727121be 1gXlO8r… <named list [38]>
...
#> ✔ Reading from iris-254e727121be.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/Rtmp07N9c8/iris-254e727121be.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-254e727121be <id: 1gXlO8rAY0cKQAqvC6HON-iElFYVjNvlh3kBJ1W655a8>
#> Saved locally as:
#> • /tmp/Rtmp07N9c8/iris-254e727121be.xlsx
```
