...
#> [1] "/tmp/RtmpAZRlxH/iris-250a5645ab4.csv"
...
#> Local file:
#> • /tmp/RtmpAZRlxH/iris-250a5645ab4.csv
#> Uploaded into Drive file:
#> • iris-250a5645ab4 <id: 1qriy-gxLGcIA1RG83JjwFXBzBZlc3zgz3eT2vVrLA78>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-250a5645ab4 1qriy-g… <named list [36]>
...
#> ✔ Reading from iris-250a5645ab4.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpAZRlxH/iris-250a5645ab4.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-250a5645ab4 <id: 1qriy-gxLGcIA1RG83JjwFXBzBZlc3zgz3eT2vVrLA78>
#> Saved locally as:
#> • /tmp/RtmpAZRlxH/iris-250a5645ab4.xlsx
```
