...
#> [1] "/tmp/RtmpAZO9wC/iris-2483130a286.csv"
...
#> Local file:
#> • /tmp/RtmpAZO9wC/iris-2483130a286.csv
#> Uploaded into Drive file:
#> • iris-2483130a286 <id: 1tmIClr7BbCaJnJE1gD1mk6XxcOu4vkqeCCGCD83_Kek>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2483130a286 1tmIClr… <named list [38]>
...
#> ✔ Reading from iris-2483130a286.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpAZO9wC/iris-2483130a286.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2483130a286 <id: 1tmIClr7BbCaJnJE1gD1mk6XxcOu4vkqeCCGCD83_Kek>
#> Saved locally as:
#> • /tmp/RtmpAZO9wC/iris-2483130a286.xlsx
```
