...
#> [1] "/tmp/RtmpUvb16a/iris-244b749b0099.csv"
...
#> Local file:
#> • /tmp/RtmpUvb16a/iris-244b749b0099.csv
#> Uploaded into Drive file:
#> • iris-244b749b0099 <id: 1NP0cutMcAd_uHeX3zPQQHE7QNnHSJnzD0n3ACPaciJo>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-244b749b0099 1NP0cut… <named list [38]>
...
#> ✔ Reading from iris-244b749b0099.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpUvb16a/iris-244b749b0099.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-244b749b0099 <id: 1NP0cutMcAd_uHeX3zPQQHE7QNnHSJnzD0n3ACPaciJo>
#> Saved locally as:
#> • /tmp/RtmpUvb16a/iris-244b749b0099.xlsx
```
