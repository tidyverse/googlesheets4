...
#> [1] "/tmp/RtmpQ9fuwt/iris-244e711b1859.csv"
...
#> Local file:
#> • /tmp/RtmpQ9fuwt/iris-244e711b1859.csv
#> Uploaded into Drive file:
#> • iris-244e711b1859 <id: 1oJetuX9Fpt8PkzgI87DJoNXfR2zyq5qY069CpaS0zn0>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-244e711b1859 1oJetuX… <named list [38]>
...
#> ✔ Reading from iris-244e711b1859.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpQ9fuwt/iris-244e711b1859.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-244e711b1859 <id: 1oJetuX9Fpt8PkzgI87DJoNXfR2zyq5qY069CpaS0zn0>
#> Saved locally as:
#> • /tmp/RtmpQ9fuwt/iris-244e711b1859.xlsx
```
