...
#> [1] "/tmp/RtmpJcuK5C/iris-2504c30a5e0.csv"
...
#> Local file:
#> • /tmp/RtmpJcuK5C/iris-2504c30a5e0.csv
#> Uploaded into Drive file:
#> • iris-2504c30a5e0 <id: 1i5uZzNAu0SDhSwa-ZkYNi8Ul20i0jEpsifuHhIZsy3w>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 iris-2504c30a5e0 1i5uZzN… <named list [38]>
...
#> ✔ Reading from iris-2504c30a5e0.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpJcuK5C/iris-2504c30a5e0.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-2504c30a5e0 <id: 1i5uZzNAu0SDhSwa-ZkYNi8Ul20i0jEpsifuHhIZsy3w>
#> Saved locally as:
#> • /tmp/RtmpJcuK5C/iris-2504c30a5e0.xlsx
```
