...
#> [1] "/tmp/RtmpUQiQHI/iris-268263a19c92.csv"
...
#> Local file:
#> • /tmp/RtmpUQiQHI/iris-268263a19c92.csv
#> Uploaded into Drive file:
#> • iris-268263a19c92 <id: 1r_gPjWMX88I6bp_8N_DCukkqjHUZ9HSq80nSBYuEGJc>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
#> # A dribble: 1 × 3
#>   name              id       drive_resource   
#>   <chr>             <drv_id> <list>           
#> 1 iris-268263a19c92 1r_gPjW… <named list [37]>
...
#> ✔ Reading from iris-268263a19c92.csv.
#> ✔ Range B1:D6.
#> # A tibble: 5 × 3
...
#> [1] "/tmp/RtmpUQiQHI/iris-268263a19c92.xlsx"
drive_download(iris_ss, path = iris_xlsxfile, overwrite = TRUE)
#> File downloaded:
#> • iris-268263a19c92 <id: 1r_gPjWMX88I6bp_8N_DCukkqjHUZ9HSq80nSBYuEGJc>
#> Saved locally as:
#> • /tmp/RtmpUQiQHI/iris-268263a19c92.xlsx
```
